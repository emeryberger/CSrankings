...
- [x] Make sure that any faculty you add meet the inclusion
      ...
      faculty members on a given campus who can _solely_ advise PhD students in
...
- [ ] If DBLP has multiple entries for this person, _all of them need to be listed_. Do not update `dblp-aliases.csv`.
...
- [ ] If the institution you are adding is not in the US,
      ...
      submit a single PR that adds _all_ of the faculty in the CS department.
