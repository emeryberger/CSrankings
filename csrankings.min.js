...
CSRankings.prototype.loadAuthors=function(a){var b=this;Papa.parse(this.authorinfoFile,{download:!0,header:!0,complete:function(d){b.authors=d.data;for(var c in b.authors){var e=b.authors[c];d=e.name;var f=e.area,h=e.dept,k=e.subarea,m=e.count,g=e.adjustedcount;e=e.year;d in b.aliases&&(d=b.aliases[d],b.authors[c]={name:d,area:f,dept:h,subarea:k,count:m,adjustedcount:g,year:e})}CSRankings.promise(a)}})};
...
CSRankings.prototype.countAuthorAreas=function(a,b){for(var d in this.authors)if(this.authors.hasOwnProperty(d)){var c=this.authors[d],e=c.name,f=c.year,h=c.area,k=c.dept;if(!(f<a||f>b||h in CSRankings.nextTier)){c=parseFloat(c.count);if(!(e in this.authorAreas)){this.authorAreas[e]={};for(var m in this.areaDict)this.areaDict.hasOwnProperty(m)&&(this.authorAreas[e][m]=0)}if(!(k in this.authorAreas)){this.authorAreas[k]={};for(var g in this.areaDict)this.areaDict.hasOwnProperty(g)&&(this.authorAreas[k][g]=
0)}this.authorAreas[e][h]+=c;this.authorAreas[k][h]+=c}}};
CSRankings.prototype.buildDepartments=function(a,b,d,c,e,f,h,k){var m={},g;for(g in this.authors)if(this.authors.hasOwnProperty(g)){var l=this.authors[g],n=l.name,q=l.year,p=l.area;l=l.dept;if(!(0===d[p]||q<a||q>b)&&this.inRegion(l,c)&&"undefined"!==typeof l){p in CSRankings.parentMap&&(p=CSRankings.parentMap[p]);q=p+l;p=n+l;q in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[q]=0);var t=parseInt(this.authors[g].count),r=parseFloat(this.authors[g].adjustedcount);this.areaDeptAdjustedCount[q]+=
r;n in m||(m[n]=!0,h[p]=0,k[p]=0,l in e||(e[l]=0,f[l]=[]),f[l].push(n),e[l]+=1);h[p]+=t;k[p]+=r}}};CSRankings.prototype.computeStats=function(a,b,d){this.stats={};for(var c in a)if(a.hasOwnProperty(c)){this.stats[c]=1;for(var e in CSRankings.topLevelAreas){var f=e+c;f in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[f]=0);0!=d[e]&&(this.stats[c]*=this.areaDeptAdjustedCount[f]+1)}this.stats[c]=Math.pow(this.stats[c],1/b)}};
