...
var CSRankings=function(){var a=this;this.authorFile="/csrankings.csv";this.authorinfoFile="/generated-author-info.csv";this.countryinfoFile="/country-info.csv";this.aliasFile="/dblp-aliases.csv";this.turingFile="./turing.csv";this.turingImage="./png/acm-turing-award.png";this.acmfellowFile="./acm-fellows.csv";this.acmfellowImage="./png/acm.png";this.homepageImage="/house-logo.png";this.allowRankingChange=!1;this.areaMap=[{area:"ai",title:"AI"},{area:"aaai",title:"AI"},{area:"ijcai",title:"AI"},{area:"vision",
title:"Vision"},{area:"cvpr",title:"Vision"},{area:"eccv",title:"Vision"},{area:"iccv",title:"Vision"},{area:"mlmining",title:"ML"},{area:"icml",title:"ML"},{area:"kdd",title:"ML"},{area:"nips",title:"ML"},{area:"nlp",title:"NLP"},{area:"acl",title:"NLP"},{area:"emnlp",title:"NLP"},{area:"naacl",title:"NLP"},{area:"ir",title:"Web+IR"},{area:"sigir",title:"Web+IR"},{area:"www",title:"Web+IR"},{area:"arch",title:"Arch"},{area:"asplos",title:"Arch"},{area:"isca",title:"Arch"},{area:"micro",title:"Arch"},
{area:"hpca",title:"Arch"},{area:"comm",title:"Networks"},{area:"sigcomm",title:"Networks"},{area:"nsdi",title:"Networks"},{area:"sec",title:"Security"},{area:"ccs",title:"Security"},{area:"oakland",title:"Security"},{area:"usenixsec",title:"Security"},{area:"ndss",title:"Security"},{area:"pets",title:"Security"},{area:"mod",title:"DB"},{area:"sigmod",title:"DB"},{area:"vldb",title:"DB"},{area:"icde",title:"DB"},{area:"pods",title:"DB"},{area:"hpc",title:"HPC"},{area:"sc",title:"HPC"},{area:"hpdc",
title:"HPC"},{area:"ics",title:"HPC"},{area:"mobile",title:"Mobile"},{area:"mobicom",title:"Mobile"},{area:"mobisys",title:"Mobile"},{area:"sensys",title:"Mobile"},{area:"metrics",title:"Metrics"},{area:"imc",title:"Metrics"},{area:"sigmetrics",title:"Metrics"},{area:"ops",title:"OS"},{area:"sosp",title:"OS"},{area:"osdi",title:"OS"},{area:"fast",title:"OS"},{area:"usenixatc",title:"OS"},{area:"eurosys",title:"OS"},{area:"pldi",title:"PL"},{area:"popl",title:"PL"},{area:"icfp",title:"PL"},{area:"oopsla",
title:"PL"},{area:"plan",title:"PL"},{area:"soft",title:"SE"},{area:"fse",title:"SE"},{area:"icse",title:"SE"},{area:"ase",title:"SE"},{area:"issta",title:"SE"},{area:"act",title:"Theory"},{area:"focs",title:"Theory"},{area:"soda",title:"Theory"},{area:"stoc",title:"Theory"},{area:"crypt",title:"Crypto"},{area:"crypto",title:"Crypto"},{area:"eurocrypt",title:"Crypto"},{area:"log",title:"Logic"},{area:"cav",title:"Logic"},{area:"lics",title:"Logic"},{area:"graph",title:"Graphics"},{area:"siggraph",
...
title:"Embedded"},{area:"rtas",title:"Embedded"},{area:"rtss",title:"Embedded"},{area:"visualization",title:"Visualization"},{area:"vis",title:"Visualization"},{area:"vr",title:"Visualization"},{area:"ecom",title:"ECom"},{area:"ec",title:"ECom"},{area:"wine",title:"ECom"}];this.aiAreas=["ai","vision","mlmining","nlp","ir"];this.systemsAreas="arch comm sec mod hpc mobile metrics ops plan soft da bed".split(" ");this.theoryAreas=["act","crypt","log"];this.interdisciplinaryAreas="graph chi robotics bio visualization ecom".split(" ");
this.areaNames=[];this.fields=[];this.aiFields=[];this.systemsFields=[];this.theoryFields=[];this.otherFields=[];this.areaDict={};this.areaPosition={};this.scholarInfo={};this.aliases={};this.turing={};this.acmfellow={};this.countryInfo={};this.homepages={};this.useDenseRankings=!1;this.authors=[];this.dblpAuthors={};this.authorAreas={};this.stats={};this.areaDeptAdjustedCount={};this.color="#f30000 #0600f3 #00b109 #14e4b4 #0fe7fb #67f200 #ff7e00 #8fe4fa #ff5300 #640000 #3854d1 #d00ed8 #7890ff #01664d #04231b #e9f117 #f3228e #7ce8ca #ff5300 #ff5300 #7eff30 #9a8cf6 #79aff9 #bfbfbf #56b510 #00e2f6 #ff4141 #61ff41".split(" ");
this.RightTriangle="&#9658;";this.DownTriangle="&#9660;";this.PieChart="<img src='png/piechart.png'>";CSRankings.theInstance=this;this.navigoRouter=new Navigo(null,!0);for(var b=0;b<this.areaMap.length;b++){var d=this.areaMap[b],c=d.area;d=d.title;CSRankings.areas[b]=c;c in CSRankings.parentMap||(CSRankings.topLevelAreas[c]=c);c in CSRankings.nextTier||(CSRankings.topTierAreas[c]=c);this.areaNames[b]=d;this.fields[b]=c;this.areaDict[c]=d;this.areaPosition[c]=b}c=$jscomp.makeIterator(this.aiAreas);
for(b=c.next();!b.done;b=c.next())this.aiFields.push(this.areaPosition[b.value]);c=$jscomp.makeIterator(this.systemsAreas);for(b=c.next();!b.done;b=c.next())this.systemsFields.push(this.areaPosition[b.value]);c=$jscomp.makeIterator(this.theoryAreas);for(b=c.next();!b.done;b=c.next())this.theoryFields.push(this.areaPosition[b.value]);c=$jscomp.makeIterator(this.interdisciplinaryAreas);for(b=c.next();!b.done;b=c.next())this.otherFields.push(this.areaPosition[b.value]);b=0;for(var e in CSRankings.parentMap)c=
CSRankings.parentMap[e],c in CSRankings.childMap?CSRankings.childMap[c].push(e):(CSRankings.childMap[c]=[e],CSRankings.parentIndex[c]=b,b+=1);this.displayProgress(1);this.loadAliases(this.aliases,function(){a.loadTuring(a.turing,function(){a.loadACMFellow(a.acmfellow,function(){a.displayProgress(2);a.loadAuthorInfo(function(){a.displayProgress(3);a.loadAuthors(function(){a.setAllOn();a.navigoRouter.on({"/index":a.navigation,"/fromyear/:fromyear/toyear/:toyear/index":a.navigation}).resolve();a.displayProgress(4);
a.loadCountryInfo(a.countryInfo,function(){setTimeout(function(){a.addListeners();CSRankings.geoCheck()},0)})})})})})})};CSRankings.getInstance=function(){return CSRankings.theInstance};CSRankings.promise=function(a){"undefined"!==typeof Promise?Promise.resolve().then(a):setTimeout(a,0)};
...
CSRankings.prototype.areaString=function(a){if(!this.authorAreas[a])return"";var b={},d=CSRankings.topTierAreas,c=0,e;for(e in d)d=this.authorAreas[a][e],e in CSRankings.parentMap&&(e=this.areaDict[e]),0<d&&(e in b||(b[e]=0),b[e]+=d,c=b[e]>c?b[e]:c);a=[];for(var f in b)a.push(b[f]);f=CSRankings.sum(a);e=0;1<a.length&&(e=Math.ceil(1*CSRankings.stddev(a)));a=[];for(var h in b)b[h]>=c-e&&.2<=1*b[h]/f&&1<b[h]&&a.push(h);return a.sort(function(a,c){return b[c]-b[a]}).slice(0,3).join(",")};
CSRankings.prototype.compareNames=function(a,b){a=a.split(" ");b=b.split(" ");a=a[a.length-1];b=b[b.length-1];return a<b?-1:a>b?1:0};
...
speed:400,size:8}},misc:{gradient:{enabled:!0,percentage:100}}})};CSRankings.prototype.displayProgress=function(a){var b="",d=1;["Loading alias data.","Loading author information.","Loading publication data.","Computing ranking."].map(function(c){b=d==a?b+("<strong>"+c+"</strong>"):b+("<font color='gray'>"+c+"</font>");b+="<br />";d+=1});jQuery("#progress").html(b)};
...
CSRankings.prototype.loadACMFellow=function(a,b){Papa.parse(this.acmfellowFile,{header:!0,download:!0,complete:function(d){d=$jscomp.makeIterator(d.data);for(var c=d.next();!c.done;c=d.next())c=c.value,a[c.name]=c.year;CSRankings.promise(b)}})};CSRankings.prototype.loadCountryInfo=function(a,b){Papa.parse(this.countryinfoFile,{header:!0,download:!0,complete:function(d){d=$jscomp.makeIterator(d.data);for(var c=d.next();!c.done;c=d.next())c=c.value,a[c.institution]=c.region;CSRankings.promise(b)}})};
CSRankings.prototype.loadAuthorInfo=function(a){var b=this;Papa.parse(this.authorFile,{download:!0,header:!0,complete:function(d){d=d.data;for(var c=0;c<d.length;c++){var e=d[c],f=e.name.trim();""!==f&&(b.dblpAuthors[f]=b.translateNameToDBLP(f),b.homepages[f]=e.homepage,b.scholarInfo[f]=e.scholarid)}CSRankings.promise(a)}})};
CSRankings.prototype.loadAuthors=function(a){var b=this;Papa.parse(this.authorinfoFile,{download:!0,header:!0,complete:function(d){b.authors=d.data;for(var c in b.authors)d=b.authors[c].name,d in b.aliases&&(d=b.aliases[d],b.authors[c].name=d);CSRankings.promise(a)}})};
...
CSRankings.prototype.activateFields=function(a,b){for(var d=0;d<b.length;d++){var c=this.fields[b[d]],e="input[name="+c+"]";jQuery(e).prop("checked",a);c in CSRankings.childMap&&(jQuery(e).prop("disabled",!1),CSRankings.childMap[c].forEach(function(b){b in CSRankings.nextTier?jQuery("input[name="+b+"]").prop("checked",!1):jQuery("input[name="+b+"]").prop("checked",a)}))}this.rank();return!1};
...
CSRankings.prototype.countAuthorAreas=function(a,b){for(var d in this.authors)if(this.authors.hasOwnProperty(d)){var c=this.authors[d],e=c.year;c=c.area;if(!(c in CSRankings.nextTier||e<a||e>b)){var f=this.authors[d];e=f.name;var h=f.dept;f=parseFloat(f.count);if(!(e in this.authorAreas)){this.authorAreas[e]={};for(var k in this.areaDict)this.areaDict.hasOwnProperty(k)&&(this.authorAreas[e][k]=0)}if(!(h in this.authorAreas)){this.authorAreas[h]={};for(var m in this.areaDict)this.areaDict.hasOwnProperty(m)&&
(this.authorAreas[h][m]=0)}this.authorAreas[e][c]+=f;this.authorAreas[h][c]+=f}}};
CSRankings.prototype.buildDepartments=function(a,b,d,c,e,f,h,k){var m={},g;for(g in this.authors)if(this.authors.hasOwnProperty(g)){var l=this.authors[g],n=l.dept;if(this.inRegion(n,c)){var p=l.area;if(0!==d[p]){var q=l.year;if(!(q<a||q>b)&&"undefined"!==typeof n){l=l.name;p in CSRankings.parentMap&&(p=CSRankings.parentMap[p]);p+=n;q=l+n;p in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[p]=0);var t=parseInt(this.authors[g].count),r=parseFloat(this.authors[g].adjustedcount);this.areaDeptAdjustedCount[p]+=
r;l in m||(m[l]=!0,h[q]=0,k[q]=0,n in e||(e[n]=0,f[n]=[]),f[n].push(l),e[n]+=1);h[q]+=t;k[q]+=r}}}}};CSRankings.prototype.computeStats=function(a,b,d){this.stats={};for(var c in a)if(a.hasOwnProperty(c)){this.stats[c]=1;for(var e in CSRankings.topLevelAreas){var f=e+c;f in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[f]=0);0!=d[e]&&(this.stats[c]*=this.areaDeptAdjustedCount[f]+1)}this.stats[c]=Math.pow(this.stats[c],1/b)}};
...
CSRankings.prototype.canonicalizeNames=function(a,b,d){for(var c in a)if(a.hasOwnProperty(c))for(var e=0;e<a[c].length;e++){var f=a[c][e];f in this.aliases&&(a[c][e]=this.aliases[f],this.aliases[f]+c in b?(b[this.aliases[f]+c]+=b[f+c],d[this.aliases[f]+c]+=d[f+c]):(b[this.aliases[f]+c]=b[f+c],d[this.aliases[f]+c]=d[f+c]))}};
CSRankings.prototype.buildDropDown=function(a,b,d){var c=this,e={},f={},h;for(h in a){f.dept=h;if(a.hasOwnProperty(f.dept)){var k='<div class="table"><table class="table table-sm table-striped"><thead><th></th><td><small><em><abbr title="Click on an author\'s name to go to their home page.">Faculty</abbr></em></small></td><td align="right"><small><em>&nbsp;&nbsp;<abbr title="Total number of publications (click for DBLP entry).">#&nbsp;Pubs</abbr></em></small></td><td align="right"><small><em><abbr title="Count divided by number of co-authors">Adj.&nbsp;#</abbr></em></small></td></thead><tbody>';f.fc=
{};for(var m=$jscomp.makeIterator(a[f.dept]),g=m.next();!g.done;g=m.next())g=g.value,f.fc[g]=b[g+f.dept];m=Object.keys(f.fc);m.sort(function(a){return function(b,f){if(a.fc[f]===a.fc[b]){var e=Math.round(10*d[f+a.dept])/10,h=Math.round(10*d[b+a.dept])/10;return e===h?c.compareNames(b,f):e-h}return a.fc[f]-a.fc[b]}}(f));m=$jscomp.makeIterator(m);for(g=m.next();!g.done;g=m.next()){g=g.value;var l=encodeURI(this.homepages[g]),n=this.dblpAuthors[g];k+='<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><small><a title="Click for author\'s home page." target="_blank" href="'+
l+'" onclick="trackOutboundLink(\''+l+"', true); return false;\">"+g+"</a>&nbsp;";this.acmfellow.hasOwnProperty(g)&&(k+='<span title="ACM Fellow"><img src="'+this.acmfellowImage+'"></span>&nbsp;');this.turing.hasOwnProperty(g)&&(k+='<span title="Turing Award"><img src="'+this.turingImage+'"></span>&nbsp;');k+='<font style="font-variant:small-caps" size="-1">'+this.areaString(g).toLowerCase()+"</em></font>&nbsp;";k+='<a title="Click for author\'s home page." target="_blank" href="'+l+'" onclick="trackOutboundLink(\''+
l+'\', true); return false;"><img src="'+this.homepageImage+'"></a>&nbsp;';this.scholarInfo.hasOwnProperty(g)&&"NOSCHOLARPAGE"!=this.scholarInfo[g]&&(l="https://scholar.google.com/citations?user="+this.scholarInfo[g]+"&hl=en&oi=ao",k+='<a title="Click for author\'s Google Scholar page." target="_blank" href="'+l+'" onclick="trackOutboundLink(\''+l+'\', true); return false;"><img src="scholar-favicon.ico" height="10" width="10"></a>&nbsp;');k+='<a title="Click for author\'s DBLP entry." target="_blank" href="'+
n+'" onclick="trackOutboundLink(\''+n+'\', true); return false;"><img src="dblp.png"></a>';k+="<span onclick='csr.toggleChart(\""+escape(g)+'");\' title="Click for author\'s publication profile." class="hovertip" ><font size="+1" color="blue">'+this.PieChart+'</font></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+n+"', true); return false;\">"+f.fc[g]+'</a></small></td><td align="right"><small>'+(Math.round(10*
d[g+f.dept])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(g)+'-chart"></div></td></tr>'}k+="</tbody></table></div>";e[f.dept]=k}f={fc:f.fc,dept:f.dept}}return e};
CSRankings.prototype.buildOutputString=function(a,b,d){var c=this.makePrologue();c+='<thead><tr><th align="left">Rank&nbsp;&nbsp;</th><th align="right">Institution&nbsp;&nbsp;</th><th align="right"><abbr title="Geometric mean count of papers published across all areas.">Count</abbr></th><th align="right">&nbsp;<abbr title="Number of faculty who have published in these areas.">Faculty</abbr></th></th></tr></thead><tbody>';if(0<a){a=1;for(var e=0,f=9999999.999,h=this.sortIndex(this.stats),k=0;k<h.length;k++){var m=
h[k],g=Math.round(10*this.stats[m])/10;if(99999<=k&&g!=f)break;if(0===g)break;f!=g&&(this.useDenseRankings?e+=1:(e+=a,a=0));f=escape(m);c+="\n<tr><td>"+e+"</td>";c+='<td><span class="hovertip" onclick="csr.toggleFaculty(\''+f+'\')";" id="'+f+'-widget"><font color="blue">'+this.RightTriangle+"</font></span>";c+="&nbsp;"+m+'&nbsp;<font color="blue"><span class="hovertip" onclick="csr.toggleChart(\''+f+'\')";" >'+this.PieChart+"</span></font>";c+="</td>";c+='<td align="right">'+(Math.round(10*g)/10).toFixed(1)+
"</td>";c+='<td align="right">'+b[m]+"<br />";c+="</td>";c+="</tr>\n";c+='<tr><td colspan="4"><div style="display:none;" style="width: 100%; height: 350px;" id="'+f+'-chart"></div></td></tr>';c+='<tr><td colspan="4"><div style="display:none;" id="'+f+'-faculty">'+d[m]+"</div></td></tr>";a++;f=g}c+="</tbody></table><br /></div></div>\n<br></body></html>"}else c="<h3>Please select at least one area by clicking one or more checkboxes.</h3>";return c};
...
CSRankings.prototype.rank=function(a){a=void 0===a?!0:a;var b={},d={},c={},e={},f={};this.areaDeptAdjustedCount={};var h=parseInt(jQuery("#fromyear").find(":selected").text()),k=parseInt(jQuery("#toyear").find(":selected").text()),m=jQuery("#regions").find(":selected").val(),g=this.updateWeights(f);this.authorAreas={};this.countAuthorAreas(h,k);this.buildDepartments(h,k,f,m,d,b,c,e);this.computeStats(b,g,f);b=this.buildDropDown(b,c,e);d=this.buildOutputString(g,d,b);jQuery("#success").html(d);a?this.navigoRouter.resume():
this.navigoRouter.pause();this.urlUpdate();return!1};CSRankings.prototype.toggleChart=function(a){var b=document.getElementById(a+"-chart");"block"===b.style.display?(b.style.display="none",b.innerHTML=""):(b.style.display="block",this.makeChart(a))};
...
"input[name="+this.fields[d]+"]",b.field=this.fields[d],jQuery(b.str).click(function(b){return function(){var c=!0;if(b.field in CSRankings.parentMap){c=!1;var d=CSRankings.parentMap[b.field],e="input[name="+d+"]",f=0,l=1;CSRankings.childMap[d].forEach(function(a){var b=jQuery("input[name="+a+"]").prop("checked");f|=b;l=a in CSRankings.nextTier?l&(b?0:1):l&b});jQuery(e).prop("checked",f);f&&!l||jQuery(e).prop("disabled",!1);f&&!l&&jQuery(e).prop("disabled",!0)}else if(d=jQuery(b.str).prop("checked"),
