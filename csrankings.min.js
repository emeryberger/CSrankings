...
a.split(" ");var b=a[a.length-1];0<parseInt(b)&&(a.pop(),b=a[a.length-1]+"_"+b);a.pop();a=a.join(" ");a=a.replace(/\s/g,"_");a=a.replace(/\-/g,"=");return"http://dblp.uni-trier.de/pers/hd"+("/"+b[0].toLowerCase()+"/"+b+":"+a)};a.makePrologue=function(){return'<div class="table-responsive" style="overflow:auto; height: 650px;"><table class="table table-sm table-striped"id="ranking" valign="top">'};a.compareNames=function(a,c){a=a.split(" ");c=c.split(" ");a=a[a.length-1];c=c[c.length-1];return a<c?
-1:a>c?1:0};a.makeChart=function(b){console.assert(a.color.length>=a.areas.length,"Houston, we have a problem.");for(var c=[],d={},f=a.areas,g=unescape(b),e=0;e<f.length;e++){var h=f[e],k=a.authorAreas[g][h];k=Math.round(10*k)/10;0<k&&(h in d||(d[h]=0),d[h]+=k)}for(h in d)c.push({label:a.areaDict[h],value:Math.round(10*d[h])/10,color:a.color[a.areaPosition[h]]});new d3pie(b+"-chart",{header:{title:{text:g,fontSize:24,font:"open sans"},subtitle:{text:"Publication Profile",color:"#999999",fontSize:14,
...
a.scholarInfo.hasOwnProperty(l)&&(p="https://scholar.google.com/citations?user="+a.scholarInfo[l]+"&hl=en&oi=ao",g+='<a title="Click for author\'s Google Scholar page." target="_blank" href="'+p+'" onclick="trackOutboundLink(\''+p+'\', true); return false;"><img src="https://scholar.google.com/favicon.ico" height="10" width="10"></a>&nbsp;');g+='<span title="Click for author\'s publication profile." onclick="CSRankings.toggleChart(\''+escape(l)+'\')" class="hovertip" ><font color="blue">'+a.PieChart+
'</font></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+t+'" onclick="trackOutboundLink(\''+t+"', true); return false;\">"+h[l]+'</a></small></td><td align="right"><small>'+(Math.round(10*d[l+e])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(l)+'-chart"></div></td></tr>'}f[e]=g+"</tbody></table></div>"},e;for(e in b)g(e);return f};a.buildOutputString=function(b,c,d,f,g){var e=a.makePrologue(),
h=parseInt(jQuery("#minToRank").find(":selected").val());e=(b?e+'<thead><tr><th align="left">Rank&nbsp;&nbsp;</th><th align="right">Institution&nbsp;&nbsp;</th><th align="right"><abbr title="Geometric mean count of papers published across all areas.">Avg.&nbsp;Count</abbr></th><th align="right">&nbsp;<abbr title="Number of faculty who have published in these areas.">Faculty</abbr></th></th></tr></thead>':e+'<thead><tr><th align="left">Rank&nbsp;</th><th align="right">Institution&nbsp;&nbsp;</th><th align="right">Adjusted&nbsp;Pub&nbsp;Count</th><th align="right">&nbsp;Faculty</th></tr></thead>')+
"<tbody>";if(0<c){b=1;c=0;for(var k=9999999.999,q=a.sortIndex(d),m=0;m<q.length;m++){var n=q[m],l=Math.round(10*d[n])/10;if(m>=h&&l!=k)break;if(0===l)break;k!=l&&(a.useDenseRankings?c+=1:(c+=b,b=0));k=escape(n);e+="\n<tr><td>"+c+"</td>";e+="<td><span onclick=\"CSRankings.toggleFaculty('"+n+'\')" class="hovertip" id="'+n+'-widget"><font color="blue">'+a.RightTriangle+"</font></span>&nbsp;<span onclick=\"CSRankings.toggleFaculty('"+n+'\')" class="hovertip">'+n+"</span>";e+='&nbsp;<font color="blue"><span onclick="CSRankings.toggleChart(\''+
k+'\')" class="hovertip" id="'+k+'-widget">'+a.PieChart+"</span></font>";e+="</td>";e+='<td align="right">'+(Math.round(10*l)/10).toFixed(1)+"</td>";e+='<td align="right">'+f[n]+"<br />";e+="</td>";e+="</tr>\n";e+='<tr><td colspan="4"><div style="display:none;" style="width: 100%; height: 350px;" id="'+k+'-chart"></div></td></tr>';e+='<tr><td colspan="4"><div style="display:none;" id="'+n+'-faculty">'+g[n]+"</div></td></tr>";b++;k=l}e+="</tbody></table><br />";a.allowRankingChange&&(e=a.useDenseRankings?
...
d,f);var m=a.buildOutputString(!0,q,a.stats,c,b);setTimeout(function(){jQuery("#success").html(m);a.urlUpdate()},0);return!1};a.toggleChart=function(b){var c=document.getElementById(b+"-chart");"block"===c.style.display?(c.style.display="none",c.innerHTML=""):(c.style.display="block",a.makeChart(b))};a.toggleConferences=function(b){var c=document.getElementById(b+"-conferences"),d=document.getElementById(b+"-widget");"block"===c.style.display?(c.style.display="none",d.innerHTML='<font color="blue">'+
