...
"southamerica"!=this.countryInfo[a])return!1;break;case "asia":if(!(a in this.countryInfo)||"asia"!=this.countryInfo[a])return!1}return!0};CSRankings.prototype.activateFields=function(a,b){for(var d=0;d<b.length;d++){var c=this.fields[b[d]],e="input[name="+c+"]";$(e).prop("checked",a);c in CSRankings.childMap&&($(e).prop("disabled",!1),CSRankings.childMap[c].forEach(function(b){var c="input[name="+b+"]";b in CSRankings.nextTier?$(c).prop("checked",!1):$(c).prop("checked",a)}))}this.rank();return!1};
...
return c};CSRankings.prototype.setAllOn=function(a){a=void 0===a?!0:a;for(var b=0;b<CSRankings.areas.length;b++){var d=this.fields[b],c="input[name="+d+"]";a?d in CSRankings.nextTier?$(c).prop("checked",!1):($(c).prop("checked",!0),$(c).prop("disabled",!1)):($(c).prop("checked",!1),$(c).prop("disabled",!1))}};
CSRankings.prototype.rank=function(a){a=void 0===a?!0:a;var b=performance.now(),d={},c={},e={},f={},h={};this.areaDeptAdjustedCount={};var l=parseInt($("#fromyear").find(":selected").text()),m=parseInt($("#toyear").find(":selected").text()),g=String($("#regions").find(":selected").val()),k=this.updateWeights(h);this.buildDepartments(l,m,h,g,c,d,e,f);this.computeStats(d,k,h);d=this.buildDropDown(d,e,f);c=this.buildOutputString(k,c,d);$("#success").html(c);a?this.navigoRouter.resume():this.navigoRouter.pause();
...
0:1):a.allChecked&c}}(c)),c.allChecked&&(a+=this.fields[e]+"&",b+=1))}0<b&&(a=a.slice(0,-1));c=$("#regions").find(":selected").val();e="";f=(new Date).getFullYear();var h=parseInt($("#fromyear").find(":selected").text()),l=parseInt($("#toyear").find(":selected").text());if(h!=f-10||l!=f)e+="/fromyear/"+h.toString(),e+="/toyear/"+l.toString();e=b==d?e+"/index?all":0==b?e+"/index?none":e+("/index?"+a);"USA"!=c&&(e+="&"+c);return e};
