...
a.loadCountryInfo(a.countryInfo,function(){setTimeout(function(){a.addListeners()},0)})})})})})};CSRankings.getInstance=function(){return CSRankings.theInstance};CSRankings.promise=function(a){"undefined"!==typeof Promise?Promise.resolve().then(a):setTimeout(a,0)};
