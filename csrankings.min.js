...
CSRankings.prototype.buildDropDown=function(a,b,d){var c=this,e={},f={},h;for(h in a){if(a.hasOwnProperty(h)){var l='<div class="table"><table class="table table-sm table-striped"><thead><th></th><td><small><em><abbr title="Click on an author\'s name to go to their home page.">Faculty</abbr></em></small></td><td align="right"><small><em>&nbsp;&nbsp;<abbr title="Total number of publications (click for DBLP entry).">#&nbsp;Pubs</abbr> </em></small></td><td align="right"><small><em><abbr title="Count divided by number of co-authors">Adj.&nbsp;#</abbr></em></small></td></thead><tbody>';f.$jscomp$loop$prop$fc$27=
{};for(var m=$jscomp.makeIterator(a[h]),g=m.next();!g.done;g=m.next())g=g.value,f.$jscomp$loop$prop$fc$27[g]=b[g];m=Object.keys(f.$jscomp$loop$prop$fc$27);m.sort(function(a){return function(b,d){return a.$jscomp$loop$prop$fc$27[d]===a.$jscomp$loop$prop$fc$27[b]?c.compareNames(b,d):a.$jscomp$loop$prop$fc$27[d]-a.$jscomp$loop$prop$fc$27[b]}}(f));m=$jscomp.makeIterator(m);for(g=m.next();!g.done;g=m.next()){g=g.value;var k=encodeURI(this.homepages[g]),n=this.dblpAuthors[g];l+='<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><small><a title="Click for author\'s home page." target="_blank" href="'+
k+'" onclick="trackOutboundLink(\''+k+"', true); return false;\">"+g+"</a>&nbsp;";this.acmfellow.hasOwnProperty(g)&&(l+='<span title="ACM Fellow"><img alt="ACM Fellow" src="'+this.acmfellowImage+'"></span>&nbsp;');this.turing.hasOwnProperty(g)&&(l+='<span title="Turing Award"><img alt="Turing Award" src="'+this.turingImage+'"></span>&nbsp;');l+='<font style="font-variant:small-caps" size="-1">'+this.areaString(g).toLowerCase()+"</em></font>&nbsp;";l+='<a title="Click for author\'s home page." target="_blank" href="'+
k+'" onclick="trackOutboundLink(\''+k+'\', true); return false;"><img alt="Home page" src="'+this.homepageImage+'"></a>&nbsp;';this.scholarInfo.hasOwnProperty(g)&&"NOSCHOLARPAGE"!=this.scholarInfo[g]&&(k="https://scholar.google.com/citations?user="+this.scholarInfo[g]+"&hl=en&oi=ao",l+='<a title="Click for author\'s Google Scholar page." target="_blank" href="'+k+'" onclick="trackOutboundLink(\''+k+'\', true); return false;"><img alt="Google Scholar" src="scholar-favicon.ico" height="10" width="10"></a>&nbsp;');
l+='<a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+n+'\', true); return false;"><img alt="DBLP" src="dblp.png"></a>';l+="<span onclick='csr.toggleChart(\""+escape(g)+'");\' title="Click for author\'s publication profile." class="hovertip" id="'+escape(g)+'-chartwidget"><font size="+1">'+this.PieChart+'</font></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+
n+"', true); return false;\">"+f.$jscomp$loop$prop$fc$27[g]+'</a></small></td><td align="right"><small>'+(Math.round(10*d[g])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(g)+'-chart"></div></td></tr>'}l+="</tbody></table></div>";e[h]=l}f={$jscomp$loop$prop$fc$27:f.$jscomp$loop$prop$fc$27}}return e};
...
CSRankings.prototype.updatedURL=function(){for(var a="",b=0,d=0,c={},e=0;e<this.fields.length;c={$jscomp$loop$prop$allChecked$29:c.$jscomp$loop$prop$allChecked$29},e++){var f="input[name="+this.fields[e]+"]";this.fields[e]in CSRankings.parentMap||(d+=1);!jQuery(f).prop("checked")||this.fields[e]in CSRankings.parentMap||(c.$jscomp$loop$prop$allChecked$29=1,this.fields[e]in CSRankings.childMap&&CSRankings.childMap[this.fields[e]].forEach(function(a){return function(b){var c=jQuery("input[name="+b+"]").prop("checked");
a.$jscomp$loop$prop$allChecked$29=b in CSRankings.nextTier?a.$jscomp$loop$prop$allChecked$29&(c?0:1):a.$jscomp$loop$prop$allChecked$29&c}}(c)),c.$jscomp$loop$prop$allChecked$29&&(a+=this.fields[e]+"&",b+=1))}0<b&&(a=a.slice(0,-1));c=jQuery("#regions").find(":selected").val();e="";f=(new Date).getFullYear();var h=parseInt(jQuery("#fromyear").find(":selected").text()),l=parseInt(jQuery("#toyear").find(":selected").text());if(h!=f-10||l!=f)e+="/fromyear/"+h.toString(),e+="/toyear/"+l.toString();e=b==
d?e+"/index?all":0==b?e+"/index?none":e+("/index?"+a);"USA"!=c&&(e+="&"+c);return e};
...
CSRankings.prototype.addListeners=function(){var a=this;["toyear","fromyear","regions"].forEach(function(b){document.getElementById(b).addEventListener("change",function(){a.countAuthorAreas();a.rank()})});for(var b={},d=0;d<CSRankings.areas.length;b={$jscomp$loop$prop$area$31:b.$jscomp$loop$prop$area$31},d++)b.$jscomp$loop$prop$area$31=CSRankings.areas[d],b.$jscomp$loop$prop$area$31 in CSRankings.parentMap||document.getElementById(b.$jscomp$loop$prop$area$31+"-widget").addEventListener("click",function(b){return function(){a.toggleConferences(b.$jscomp$loop$prop$area$31)}}(b));
b={};for(d=0;d<this.fields.length;b={$jscomp$loop$prop$field$33:b.$jscomp$loop$prop$field$33,$jscomp$loop$prop$str$34:b.$jscomp$loop$prop$str$34},d++)b.$jscomp$loop$prop$str$34="input[name="+this.fields[d]+"]",b.$jscomp$loop$prop$field$33=this.fields[d],jQuery(b.$jscomp$loop$prop$str$34).click(function(b){return function(){var c=!0;if(b.$jscomp$loop$prop$field$33 in CSRankings.parentMap){c=!1;var d=CSRankings.parentMap[b.$jscomp$loop$prop$field$33],e="input[name="+d+"]",f=0,k=1;CSRankings.childMap[d].forEach(function(a){var b=
jQuery("input[name="+a+"]").prop("checked");f|=b;k=a in CSRankings.nextTier?k&(b?0:1):k&b});jQuery(e).prop("checked",f);f&&!k||jQuery(e).prop("disabled",!1);f&&!k&&jQuery(e).prop("disabled",!0)}else if(d=jQuery(b.$jscomp$loop$prop$str$34).prop("checked"),b.$jscomp$loop$prop$field$33 in CSRankings.childMap){e=$jscomp.makeIterator(CSRankings.childMap[b.$jscomp$loop$prop$field$33]);for(var n=e.next();!n.done;n=e.next()){n=n.value;var p="input[name="+n+"]";n in CSRankings.nextTier?jQuery(p).prop("checked",
!1):jQuery(p).prop("checked",d)}}a.rank(c)}}(b));var c={all_areas_on:function(){a.activateAll()},all_areas_off:function(){a.activateNone()},ai_areas_on:function(){a.activateAI()},ai_areas_off:function(){a.deactivateAI()},systems_areas_on:function(){a.activateSystems()},systems_areas_off:function(){a.deactivateSystems()},theory_areas_on:function(){a.activateTheory()},theory_areas_off:function(){a.deactivateTheory()},other_areas_on:function(){a.activateOthers()},other_areas_off:function(){a.deactivateOthers()}};
b={};for(var e in c)b.$jscomp$loop$prop$item$36=e,document.getElementById(b.$jscomp$loop$prop$item$36).addEventListener("click",function(a){return function(){c[a.$jscomp$loop$prop$item$36]()}}(b)),b={$jscomp$loop$prop$item$36:b.$jscomp$loop$prop$item$36}};CSRankings.areas=[];CSRankings.topLevelAreas={};CSRankings.topTierAreas={};CSRankings.regions="USA europe canada northamerica southamerica australasia asia world".split(" ");CSRankings.parentIndex={};
