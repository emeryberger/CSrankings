...
c.length;b++)d=c[b],a.otherFields.push(a.areaPosition[d]);a.loadAliases(a.aliases,function(){a.loadAuthorInfo(function(){a.loadAuthors(function(){a.loadCountryInfo(a.countryInfo,function(){a.activateAll();a.rank();a.navigoRouter=new Navigo(null,!0);a.navigoRouter.on("/index",a.navigator).resolve();a.navigoRouter.on("/fromyear/:fromyear/toyear/:toyear/index",a.navigator).resolve()})})})})}a.translateNameToDBLP=function(a){a=a.replace(/'|\-|\./g,"=");a=a.replace(/\u00c1/g,"=Aacute=");a=a.replace(/\u00e1/g,
...
a.buildDepartments(a.authors,e,g,h,l,a.areaDeptAdjustedCount,c,b,d,f);a.stats=a.computeStats(b,a.areaDeptAdjustedCount,a.areas,q,!0,h);a.canonicalizeNames(b,d,f);b=a.buildDropDown(b,d,f);c=a.buildOutputString(!0,q,a.stats,c,b);jQuery("#success").html(c);a.urlUpdate();return!1};a.toggleChart=function(b){var c=document.getElementById(b+"-chart");"block"===c.style.display?(c.style.display="none",c.innerHTML=""):(c.style.display="block",a.makeChart(b))};a.toggleConferences=function(b){var c=document.getElementById(b+
...
CSRankings.allowRankingChange=!1;CSRankings.parentMap={aaai:"ai",ijcai:"ai",cvpr:"vision",eccv:"vision",iccv:"vision"};CSRankings.childMap={ai:["aaai","ijcai"],vision:["cvpr","eccv","iccv"]};
