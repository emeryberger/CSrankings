...
CSRankings.prototype.countAuthorAreas=function(a,b){for(var d in this.authors)if(this.authors.hasOwnProperty(d)){var c=this.authors[d],e=c.year;c=c.area;if(!(c in CSRankings.nextTier||e<a||e>b)){var f=this.authors[d];e=f.name;var h=f.dept;f=parseFloat(f.count);if(!(e in this.authorAreas)){this.authorAreas[e]={};for(var l in this.areaDict)this.areaDict.hasOwnProperty(l)&&(this.authorAreas[e][l]=0)}if(!(h in this.authorAreas)){this.authorAreas[h]={};for(var m in this.areaDict)this.areaDict.hasOwnProperty(m)&&
(this.authorAreas[h][m]=0)}this.authorAreas[e][c]+=f;this.authorAreas[h][c]+=f}}};
CSRankings.prototype.buildDepartments=function(a,b,d,c,e,f,h,l){var m={},g;for(g in this.authors)if(this.authors.hasOwnProperty(g)){var k=this.authors[g],n=k.name,q=k.year,p=k.area;k=k.dept;if(this.inRegion(k,c)&&!(0===d[p]||q<a||q>b)&&"undefined"!==typeof k){p in CSRankings.parentMap&&(p=CSRankings.parentMap[p]);q=p+k;p=n+k;q in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[q]=0);var t=parseInt(this.authors[g].count),r=parseFloat(this.authors[g].adjustedcount);this.areaDeptAdjustedCount[q]+=
r;n in m||(m[n]=!0,h[p]=0,l[p]=0,k in e||(e[k]=0,f[k]=[]),f[k].push(n),e[k]+=1);h[p]+=t;l[p]+=r}}};CSRankings.prototype.computeStats=function(a,b,d){this.stats={};for(var c in a)if(a.hasOwnProperty(c)){this.stats[c]=1;for(var e in CSRankings.topLevelAreas){var f=e+c;f in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[f]=0);0!=d[e]&&(this.stats[c]*=this.areaDeptAdjustedCount[f]+1)}this.stats[c]=Math.pow(this.stats[c],1/b)}};
...
CSRankings.prototype.buildDropDown=function(a,b,d){var c=this,e={},f={},h;for(h in a){f.dept=h;if(a.hasOwnProperty(f.dept)){var l='<div class="table"><table class="table table-sm table-striped"><thead><th></th><td><small><em><abbr title="Click on an author\'s name to go to their home page.">Faculty</abbr></em></small></td><td align="right"><small><em>&nbsp;&nbsp;<abbr title="Total number of publications (click for DBLP entry).">#&nbsp;Pubs</abbr></em></small></td><td align="right"><small><em><abbr title="Count divided by number of co-authors">Adj.&nbsp;#</abbr></em></small></td></thead><tbody>';f.fc=
{};for(var m=$jscomp.makeIterator(a[f.dept]),g=m.next();!g.done;g=m.next())g=g.value,f.fc[g]=b[g+f.dept];m=Object.keys(f.fc);m.sort(function(a){return function(b,f){if(a.fc[f]===a.fc[b]){var e=Math.round(10*d[f+a.dept])/10,h=Math.round(10*d[b+a.dept])/10;return e===h?c.compareNames(b,f):e-h}return a.fc[f]-a.fc[b]}}(f));m=$jscomp.makeIterator(m);for(g=m.next();!g.done;g=m.next()){g=g.value;var k=encodeURI(this.homepages[g]),n=this.dblpAuthors[g];l+='<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><small><a title="Click for author\'s home page." target="_blank" href="'+
k+'" onclick="trackOutboundLink(\''+k+"', true); return false;\">"+g+"</a>&nbsp;";this.acmfellow.hasOwnProperty(g)&&(l+='<span title="ACM Fellow"><img src="'+this.acmfellowImage+'"></span>&nbsp;');this.turing.hasOwnProperty(g)&&(l+='<span title="Turing Award"><img src="'+this.turingImage+'"></span>&nbsp;');l+='<font style="font-variant:small-caps" size="-1">'+this.areaString(g).toLowerCase()+"</em></font>&nbsp;";l+='<a title="Click for author\'s home page." target="_blank" href="'+k+'" onclick="trackOutboundLink(\''+
k+'\', true); return false;"><img src="'+this.homepageImage+'"></a>&nbsp;';this.scholarInfo.hasOwnProperty(g)&&"NOSCHOLARPAGE"!=this.scholarInfo[g]&&(k="https://scholar.google.com/citations?user="+this.scholarInfo[g]+"&hl=en&oi=ao",l+='<a title="Click for author\'s Google Scholar page." target="_blank" href="'+k+'" onclick="trackOutboundLink(\''+k+'\', true); return false;"><img src="scholar-favicon.ico" height="10" width="10"></a>&nbsp;');l+='<a title="Click for author\'s DBLP entry." target="_blank" href="'+
n+'" onclick="trackOutboundLink(\''+n+'\', true); return false;"><img src="dblp.png"></a>';l+="<span onclick='csr.toggleChart(\""+escape(g)+'");\' title="Click for author\'s publication profile." class="hovertip" ><font size="+1" color="blue">'+this.PieChart+'</font></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+n+"', true); return false;\">"+f.fc[g]+'</a></small></td><td align="right"><small>'+(Math.round(10*
d[g+f.dept])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(g)+'-chart"></div></td></tr>'}l+="</tbody></table></div>";e[f.dept]=l}f={fc:f.fc,dept:f.dept}}return e};
CSRankings.prototype.buildOutputString=function(a,b,d){var c=this.makePrologue();c+='<thead><tr><th align="left">Rank&nbsp;&nbsp;</th><th align="right">Institution&nbsp;&nbsp;</th><th align="right"><abbr title="Geometric mean count of papers published across all areas.">Count</abbr></th><th align="right">&nbsp;<abbr title="Number of faculty who have published in these areas.">Faculty</abbr></th></th></tr></thead><tbody>';if(0<a){a=1;for(var e=0,f=9999999.999,h=this.sortIndex(this.stats),l=0;l<h.length;l++){var m=
h[l],g=Math.round(10*this.stats[m])/10;if(99999<=l&&g!=f)break;if(0===g)break;f!=g&&(this.useDenseRankings?e+=1:(e+=a,a=0));f=escape(m);c+="\n<tr><td>"+e+"</td>";c+='<td><span class="hovertip" onclick="csr.toggleFaculty(\''+f+'\')";" id="'+f+'-widget"><font color="blue">'+this.RightTriangle+"</font></span>";c+="&nbsp;"+m+'&nbsp;<font color="blue"><span class="hovertip" onclick="csr.toggleChart(\''+f+'\')";" >'+this.PieChart+"</span></font>";c+="</td>";c+='<td align="right">'+(Math.round(10*g)/10).toFixed(1)+
...
CSRankings.prototype.rank=function(a){a=void 0===a?!0:a;var b={},d={},c={},e={},f={};this.areaDeptAdjustedCount={};var h=parseInt(jQuery("#fromyear").find(":selected").text()),l=parseInt(jQuery("#toyear").find(":selected").text()),m=jQuery("#regions").find(":selected").val(),g=this.updateWeights(f);this.authorAreas={};this.countAuthorAreas(h,l);this.buildDepartments(h,l,f,m,d,b,c,e);this.computeStats(b,g,f);b=this.buildDropDown(b,c,e);d=this.buildOutputString(g,d,b);jQuery("#success").html(d);a?this.navigoRouter.resume():
