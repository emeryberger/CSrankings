...
0;a<this.onSettledCallbacks_.length;++a)f.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var f=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(h){c.reject(h)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(t){g(t)}}:
...
c){for(var e=$jscomp.makeIterator(a),g=e.next();!g.done;g=e.next())d(g.value).callWhenSettled_(b,c)})};e.all=function(a){var b=$jscomp.makeIterator(a),c=b.next();return c.done?d([]):new e(function(a,e){function g(b){return function(c){f[b]=c;k--;0==k&&a(f)}}var f=[],k=0;do f.push(void 0),k++,d(c.value).callWhenSettled_(g(f.length-1),e),c=b.next();while(!c.done)})};return e},"es6","es3");
...
speed:400,size:8}},misc:{gradient:{enabled:!0,percentage:100}}})};CSRankings.prototype.displayProgress=function(a){var b="",d=1;["Initializing.","Loading author information.","Loading publication data.","Computing ranking."].map(function(c){b=d==a?b+("<strong>"+c+"</strong>"):b+("<font color='gray'>"+c+"</font>");b+="<br />";d+=1});document.querySelector("#progress").innerHTML=b};
...
CSRankings.prototype.buildOutputString=function(a,b,d,c){var e=this.makePrologue();e=e+'<thead><tr><th align="left"><font color="#777">#</font></th><th align="left"><font color="#777">Institution</font>'+"&nbsp;".repeat(20)+'</th><th align="right"><abbr title="Geometric mean count of papers published across all areas."><font color="#777">Count</font></abbr></th><th align="right">&nbsp;<abbr title="Number of faculty who have published in these areas."><font color="#777">Faculty</font></abbr></th></th></tr></thead>';
e+="<tbody>";if(0<a){a=1;var f=0,g=9999999.999;for(k in this.stats)this.stats[k]=Math.round(10*this.stats[k])/10;var k=this.sortIndex(this.stats);for(var l=0;l<k.length;l++){var h=k[l],m=this.stats[h];if(l>=c&&m!=g)break;if(0===m)break;g!=m&&(this.useDenseRankings?f+=1:(f+=a,a=0));g=escape(h);e+="\n<tr><td>"+f;e+="&nbsp;".repeat(4-Math.ceil(Math.log10(f)));e+="</td>";e+='<td><span class="hovertip" onclick="csr.toggleFaculty(\''+g+'\');" id="'+g+'-widget">'+this.RightTriangle+"</span>";e+="&nbsp;"+
h+'&nbsp;<span class="hovertip" onclick="csr.toggleChart(\''+g+'\');" id="'+g+'-chartwidget">'+this.PieChart+"</span>";e+="</td>";e+='<td align="right">'+(Math.round(10*m)/10).toFixed(1)+"</td>";e+='<td align="right">'+b[h];e+="</td>";e+="</tr>\n";e+='<tr><td colspan="4"><div class="csr-piechart" id="'+g+'-chart"></div></td></tr>';e+='<tr><td colspan="4"><div style="display:none;" id="'+g+'-faculty">'+d[h]+"</div></td></tr>";a++;g=m}e+="</tbody></table><br /></div></div>\n<br></body></html>"}else e=
"<h3>Please select at least one area by clicking one or more checkboxes.</h3>";return e};CSRankings.prototype.setAllOn=function(a){a=void 0===a?!0:a;for(var b=0;b<CSRankings.areas.length;b++){var d=this.fields[b],c="input[name="+d+"]";a?d in CSRankings.nextTier?$(c).prop("checked",!1):($(c).prop("checked",!0),$(c).prop("disabled",!1)):($(c).prop("checked",!1),$(c).prop("disabled",!1))}};
...
(m-b)+" milliseconds.");document.getElementById("success").innerHTML=c;$("div").scroll(function(){if(this.scrollTop+this.clientHeight>this.scrollHeight-50){var a=CSRankings.updateMinimum(this);a&&$("div").scrollTop(a)}});a?this.navigoRouter.resume():this.navigoRouter.pause();a=this.updatedURL();this.navigoRouter.navigate(a);m=performance.now();console.log("Rank took "+(m-b)+" milliseconds.");return!1};
...
CSRankings.prototype.addListeners=function(){var a=this;["toyear","fromyear","regions"].forEach(function(b){document.getElementById(b).addEventListener("change",function(){a.countAuthorAreas();a.rank()})});for(var b={},d=0;d<CSRankings.areas.length;b={area:b.area},d++)if(b.area=CSRankings.areas[d],!(b.area in CSRankings.parentMap)){var c=document.getElementById(b.area+"-widget");c&&c.addEventListener("click",function(b){return function(){a.toggleConferences(b.area)}}(b))}b={};for(d=0;d<this.fields.length;b=
{field:b.field,str:b.str},d++)b.str="input[name="+this.fields[d]+"]",b.field=this.fields[d],(c=document.getElementById(this.fields[d]))&&c.addEventListener("click",function(b){return function(){var c=!0;if(b.field in CSRankings.parentMap){c=!1;var d=CSRankings.parentMap[b.field],e="input[name="+d+"]",f=0,g=1;CSRankings.childMap[d].forEach(function(a){var b=$("input[name="+a+"]").prop("checked");f|=b;g=a in CSRankings.nextTier?g&(b?0:1):g&b});$(e).prop("checked",f);f&&!g||$(e).prop("disabled",!1);
f&&!g&&$(e).prop("disabled",!0)}else if(d=$(b.str).prop("checked"),b.field in CSRankings.childMap){e=$jscomp.makeIterator(CSRankings.childMap[b.field]);for(var p=e.next();!p.done;p=e.next()){p=p.value;var q="input[name="+p+"]";p in CSRankings.nextTier?$(q).prop("checked",!1):$(q).prop("checked",d)}}a.rank(c)}}(b));var e={all_areas_on:function(){a.activateAll()},all_areas_off:function(){a.activateNone()},ai_areas_on:function(){a.activateAI()},ai_areas_off:function(){a.deactivateAI()},systems_areas_on:function(){a.activateSystems()},
systems_areas_off:function(){a.deactivateSystems()},theory_areas_on:function(){a.activateTheory()},theory_areas_off:function(){a.deactivateTheory()},other_areas_on:function(){a.activateOthers()},other_areas_off:function(){a.deactivateOthers()}};b={};for(var f in e)b.item=f,document.getElementById(b.item).addEventListener("click",function(a){return function(){e[a.item]()}}(b)),b={item:b.item}};CSRankings.minToRank=30;CSRankings.areas=[];CSRankings.topLevelAreas={};CSRankings.topTierAreas={};
CSRankings.regions="USA europe canada northamerica southamerica australasia asia africa world".split(" ");CSRankings.nameMatcher=/(.*)\s+\[(.*)\]/;CSRankings.parentIndex={};
