...
{area:"oakland",title:"Security"},{area:"usenixsec",title:"Security"},{area:"ndss",title:"Security"},{area:"mod",title:"DB"},{area:"sigmod",title:"DB"},{area:"vldb",title:"DB"},{area:"icde",title:"DB"},{area:"pods",title:"DB"},{area:"hpc",title:"HPC"},{area:"sc",title:"HPC"},{area:"hpdc",title:"HPC"},{area:"ics",title:"HPC"},{area:"mobile",title:"Mobile"},{area:"mobicom",title:"Mobile"},{area:"mobisys",title:"Mobile"},{area:"sensys",title:"Mobile"},{area:"metrics",title:"Metrics"},{area:"imc",title:"Metrics"},
{area:"sigmetrics",title:"Metrics"},{area:"ops",title:"OS"},{area:"sosp",title:"OS"},{area:"osdi",title:"OS"},{area:"fast",title:"OS"},{area:"usenixatc",title:"OS"},{area:"eurosys",title:"OS"},{area:"pldi",title:"PL"},{area:"popl",title:"PL"},{area:"icfp",title:"PL"},{area:"oopsla",title:"PL"},{area:"plan",title:"PL"},{area:"soft",title:"SE"},{area:"fse",title:"SE"},{area:"icse",title:"SE"},{area:"ase",title:"SE"},{area:"issta",title:"SE"},{area:"act",title:"Theory"},{area:"focs",title:"Theory"},
...
(m-b)+" milliseconds.");document.getElementById("success").innerHTML=c;$("div").scroll(function(){console.log("scrollTop = "+this.scrollTop+", clientHeight = "+this.clientHeight+", scrollHeight = "+this.scrollHeight);if(this.scrollTop+this.clientHeight>this.scrollHeight-50){var a=CSRankings.updateMinimum(this);a&&$("div").scrollTop(a)}});a?this.navigoRouter.resume():this.navigoRouter.pause();a=this.updatedURL();this.navigoRouter.navigate(a);m=performance.now();console.log("Rank took "+(m-b)+" milliseconds.");
return!1};CSRankings.prototype.toggleChart=function(a){var b=document.getElementById(a+"-chart"),d=document.getElementById(a+"-chartwidget");"block"===b.style.display?(b.style.display="none",b.innerHTML="",d.innerHTML=this.PieChart):(b.style.display="block",this.makeChart(a),d.innerHTML=this.OpenPieChart)};
...
str:b.str},d++)b.str="input[name="+this.fields[d]+"]",b.field=this.fields[d],document.getElementById(this.fields[d]).addEventListener("click",function(b){return function(){var c=!0;if(b.field in CSRankings.parentMap){c=!1;var d=CSRankings.parentMap[b.field],e="input[name="+d+"]",f=0,m=1;CSRankings.childMap[d].forEach(function(a){var b=$("input[name="+a+"]").prop("checked");f|=b;m=a in CSRankings.nextTier?m&(b?0:1):m&b});$(e).prop("checked",f);f&&!m||$(e).prop("disabled",!1);f&&!m&&$(e).prop("disabled",
!0)}else if(d=$(b.str).prop("checked"),b.field in CSRankings.childMap){e=$jscomp.makeIterator(CSRankings.childMap[b.field]);for(var n=e.next();!n.done;n=e.next()){n=n.value;var p="input[name="+n+"]";n in CSRankings.nextTier?$(p).prop("checked",!1):$(p).prop("checked",d)}}a.rank(c)}}(b));var c={all_areas_on:function(){a.activateAll()},all_areas_off:function(){a.activateNone()},ai_areas_on:function(){a.activateAI()},ai_areas_off:function(){a.deactivateAI()},systems_areas_on:function(){a.activateSystems()},
systems_areas_off:function(){a.deactivateSystems()},theory_areas_on:function(){a.activateTheory()},theory_areas_off:function(){a.deactivateTheory()},other_areas_on:function(){a.activateOthers()},other_areas_off:function(){a.deactivateOthers()}};b={};for(var e in c)b.item=e,document.getElementById(b.item).addEventListener("click",function(a){return function(){c[a.item]()}}(b)),b={item:b.item}};CSRankings.minToRank=30;CSRankings.areas=[];CSRankings.topLevelAreas={};CSRankings.topTierAreas={};
