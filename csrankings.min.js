...
m+'" onclick="trackOutboundLink(\''+m+"', true); return false;\">"+g+"</a>&nbsp;";this.acmfellow.hasOwnProperty(g)&&(k+='<span title="ACM Fellow"><img src="png/acm.png"></span>&nbsp;');this.turing.hasOwnProperty(g)&&(k+='<span title="Turing Award"><img src="png/acm-turing-award.png"></span>&nbsp;');k+='<font style="font-variant:small-caps" size="-1">'+this.areaString(g).toLowerCase()+"</em></font>&nbsp;";k+='<a title="Click for author\'s home page." target="_blank" href="'+m+'" onclick="trackOutboundLink(\''+
