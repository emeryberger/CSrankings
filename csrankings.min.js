...
a=this.updatedURL();this.navigoRouter.navigate(a);a=performance.now();console.log("Rank took "+(a-b)+" milliseconds.");return!1};CSRankings.prototype.toggleChart=function(a){var b=document.getElementById(a+"-chart");"block"===b.style.display?(b.style.display="none",b.innerHTML=""):(b.style.display="block",this.makeChart(a))};
