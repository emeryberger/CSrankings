...
'</font></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+t+'" onclick="trackOutboundLink(\''+t+"', true); return false;\">"+h[l]+'</a></small></td><td align="right"><small>'+(Math.round(10*d[l+e])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(l)+'-chart"></div></td></tr>'}f[e]=g+"</tbody></table></div></div>"},e;for(e in b)g(e);return f};a.buildOutputString=function(b,c,d,f,g){var e=a.makePrologue(),
