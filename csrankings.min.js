...
CSRankings.prototype.rank=function(a){a=void 0===a?!0:a;var b=performance.now(),d={},c={},e={},f={},h={};this.areaDeptAdjustedCount={};var k=parseInt(jQuery("#fromyear").find(":selected").text()),m=parseInt(jQuery("#toyear").find(":selected").text()),g=jQuery("#regions").find(":selected").val(),l=this.updateWeights(h);this.authorAreas={};this.countAuthorAreas(k,m);this.buildDepartments(k,m,h,g,c,d,e,f);this.computeStats(d,l,h);d=this.buildDropDown(d,e,f);c=this.buildOutputString(l,c,d);jQuery("#success").html(c);
a?this.navigoRouter.resume():this.navigoRouter.pause();this.urlUpdate();a=performance.now();console.log("Rank took "+(a-b)+" milliseconds.");return!1};CSRankings.prototype.toggleChart=function(a){var b=document.getElementById(a+"-chart");"block"===b.style.display?(b.style.display="none",b.innerHTML=""):(b.style.display="block",this.makeChart(a))};
