...
n+'\', true); return false;"><img alt="DBLP" src="dblp.png"></a>';l+="<span onclick='csr.toggleChart(\""+escape(h)+'");\' title="Click for author\'s publication profile." class="hovertip" id="'+escape(h)+"-chartwidget\"><span class='piechart'>"+this.PieChart+'</span></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+n+"', true); return false;\">"+f.fc[h]+'</a></small></td><td align="right"><small>'+(Math.round(10*
d[h])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(h)+'-chart"></div></td></tr>'}l+="</tbody></table></div>";e[g]=l}f={fc:f.fc}}return e};
