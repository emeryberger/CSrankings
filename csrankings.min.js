...
$jscomp.polyfill("Symbol",function(a){if(a)return a;var b=function(k,e){this.$jscomp$symbol$id_=k;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:e})};b.prototype.toString=function(){return this.$jscomp$symbol$id_};var c="jscomp_symbol_"+(1E9*Math.random()>>>0)+"_",d=0,f=function(k){if(this instanceof f)throw new TypeError("Symbol is not a constructor");return new b(c+(k||"")+"_"+d++,k)};return f},"es6","es3");
...
e.callWhenSettled_(g.resolve,g.reject)};f.prototype.settleSameAsThenable_=function(e,g){var h=this.createResolveAndReject_();try{e.call(g,h.resolve,h.reject)}catch(l){h.reject(l)}};f.prototype.then=function(e,g){function h(p,q){return"function"==typeof p?function(r){try{l(p(r))}catch(t){m(t)}}:q}var l,m,n=new f(function(p,q){l=p;m=q});this.callWhenSettled_(h(e,l),h(g,m));return n};f.prototype.catch=function(e){return this.then(void 0,e)};f.prototype.callWhenSettled_=function(e,g){function h(){switch(l.state_){case 1:e(l.result_);
...
m){function n(r){return function(t){p[r]=t;q--;0==q&&l(p)}}var p=[],q=0;do p.push(void 0),q++,c(h.value).callWhenSettled_(n(p.length-1),m),h=g.next();while(!h.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(a,b){a instanceof String&&(a+="");var c=0,d=!1,f={next:function(){if(!d&&c<a.length){var k=c++;return{value:b(k,a[k]),done:!1}}d=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
var __awaiter=this&&this.__awaiter||function(a,b,c,d){function f(k){return k instanceof c?k:new c(function(e){e(k)})}return new (c||(c=Promise))(function(k,e){function g(m){try{l(d.next(m))}catch(n){e(n)}}function h(m){try{l(d["throw"](m))}catch(n){e(n)}}function l(m){m.done?k(m.value):f(m.value).then(g,h)}l((d=d.apply(a,b||[])).next())})},CSRankings=function(){var a=this;this.note={};this.authorFile="./csrankings.csv";this.authorinfoFile="./generated-author-info.csv";this.countryinfoFile="./country-info.csv";
...
d.next())this.otherFields.push(this.areaPosition[b.value]);b=0;for(var f in CSRankings.parentMap)d=CSRankings.parentMap[f],d in CSRankings.childMap?CSRankings.childMap[d].push(f):(CSRankings.childMap[d]=[f],CSRankings.parentIndex[d]=b,b+=1);this.displayProgress(1);(function(){return __awaiter(a,void 0,void 0,function e(){var g=this;return $jscomp.generator.createGenerator(e,function(h){switch(h.nextAddress){case 1:return h.yield(g.loadTuring(g.turing),2);case 2:return h.yield(g.loadACMFellow(g.acmfellow),
3);case 3:return g.displayProgress(2),h.yield(g.loadAuthorInfo(),4);case 4:return g.displayProgress(3),h.yield(g.loadAuthors(),5);case 5:return g.setAllOn(),g.navigoRouter.on({"/index":g.navigation,"/fromyear/:fromyear/toyear/:toyear/index":g.navigation}).resolve(),g.displayProgress(4),g.countAuthorAreas(),h.yield(g.loadCountryInfo(g.countryInfo,g.countryAbbrv),6);case 6:g.addListeners(),CSRankings.geoCheck(),g.rank(),h.jumpToEnd()}})})})()};
...
CSRankings.prototype.makeChart=function(a){var b=this,c=[],d={},f=CSRankings.topTierAreas,k=unescape(a),e=[].concat($jscomp.arrayFromIterable(this.aiAreas.map(function(h){return{key:h,label:b.areaDict[h],color:"#8da0cb"}})),$jscomp.arrayFromIterable(this.systemsAreas.map(function(h){return{key:h,label:b.areaDict[h],color:"#fc8d62"}})),$jscomp.arrayFromIterable(this.theoryAreas.map(function(h){return{key:h,label:b.areaDict[h],color:"#66c2a5"}})),$jscomp.arrayFromIterable(this.interdisciplinaryAreas.map(function(h){return{key:h,
label:b.areaDict[h],color:"#e78ac3"}})));e.forEach(function(h){return d[h.key]=0});for(var g in f){if(!(k in this.authorAreas))return;f=this.authorAreas[k][g];f=Math.round(10*f)/10;0<f&&(g in CSRankings.parentMap&&(g=CSRankings.parentMap[g]),d[g]+=f)}e.forEach(function(h){c.push({area:b.areaDict[h.key],value:Math.round(10*d[h.key])/10});h.label=b.areaDict[h.key]});k=e.sort(function(h,l){return h.label>l.label?1:h.label<l.label?-1:0}).map(function(h){return h.color});vegaEmbed('div[id="'+a+'-chart"]',
{$schema:"https://vega.github.io/schema/vega-lite/v5.json",data:{values:c},mark:"bar",encoding:{x:{field:"area",type:"nominal",sort:null,axis:{title:null}},y:{field:"value",type:"quantitative",axis:{title:null}},tooltip:[{field:"area",type:"nominal",title:"Area"},{field:"value",type:"quantitative",title:"Count"}],color:{field:"area",type:"nominal",scale:{range:k},legend:null}},width:420,height:80,padding:{left:25,top:3}},{actions:!1})};
CSRankings.prototype.displayProgress=function(a){var b="",c=1;["Initializing.","Loading author information.","Loading publication data.","Computing ranking."].map(function(d){b=c==a?b+("<strong>"+d+"</strong>"):b+("<font color='gray'>"+d+"</font>");b+="<br />";c+=1});document.querySelector("#progress").innerHTML=b};
CSRankings.prototype.loadTuring=function(a){return __awaiter(this,void 0,void 0,function c(){var d=this,f,k,e,g,h,l;return $jscomp.generator.createGenerator(c,function(m){if(1==m.nextAddress)return f=d,m.yield(new Promise(function(n){Papa.parse(f.turingFile,{header:!0,download:!0,complete:function(p){n(p.data)}})}),2);e=k=m.yieldResult;g=$jscomp.makeIterator(e);for(h=g.next();!h.done;h=g.next())l=h.value,a[l.name]=l.year;m.jumpToEnd()})})};
CSRankings.prototype.loadACMFellow=function(a){return __awaiter(this,void 0,void 0,function c(){var d=this,f,k,e,g,h,l;return $jscomp.generator.createGenerator(c,function(m){if(1==m.nextAddress)return f=d,m.yield(new Promise(function(n){Papa.parse(f.acmfellowFile,{header:!0,download:!0,complete:function(p){n(p.data)}})}),2);e=k=m.yieldResult;g=$jscomp.makeIterator(e);for(h=g.next();!h.done;h=g.next())l=h.value,a[l.name]=l.year;m.jumpToEnd()})})};
CSRankings.prototype.loadCountryInfo=function(a,b){return __awaiter(this,void 0,void 0,function d(){var f=this,k,e,g,h,l,m;return $jscomp.generator.createGenerator(d,function(n){if(1==n.nextAddress)return k=f,n.yield(new Promise(function(p){Papa.parse(k.countryinfoFile,{header:!0,download:!0,complete:function(q){p(q.data)}})}),2);g=e=n.yieldResult;h=$jscomp.makeIterator(g);for(l=h.next();!l.done;l=h.next())m=l.value,a[m.institution]=m.region,b[m.institution]=m.countryabbrv;n.jumpToEnd()})})};
CSRankings.prototype.loadAuthorInfo=function(){return __awaiter(this,void 0,void 0,function b(){var c=this,d,f,k,e,g,h,l;return $jscomp.generator.createGenerator(b,function(m){if(1==m.nextAddress)return d=c,m.yield(new Promise(function(n){Papa.parse(d.authorFile,{download:!0,header:!0,complete:function(p){n(p.data)}})}),2);k=f=m.yieldResult;for(e=0;e<k.length;e++){g=k[e];h=g.name.trim();if(l=h.match(CSRankings.nameMatcher))h=l[1].trim(),c.note[h]=l[2];""!==h&&(c.dblpAuthors[h]=c.translateNameToDBLP(h),
c.homepages[h]=g.homepage,c.scholarInfo[h]=g.scholarid)}m.jumpToEnd()})})};CSRankings.prototype.loadAuthors=function(){return __awaiter(this,void 0,void 0,function b(){var c=this,d,f;return $jscomp.generator.createGenerator(b,function(k){if(1==k.nextAddress)return d=c,k.yield(new Promise(function(e){Papa.parse(d.authorinfoFile,{download:!0,header:!0,complete:function(g){e(g.data)}})}),2);f=k.yieldResult;c.authors=f;k.jumpToEnd()})})};
...
CSRankings.prototype.activateFields=function(a,b){for(var c=0;c<b.length;c++){var d=this.fields[b[c]],f="input[name="+d+"]";$(f).prop("checked",a);d in CSRankings.childMap&&($(f).prop("disabled",!1),CSRankings.childMap[d].forEach(function(k){var e="input[name="+k+"]";k in CSRankings.nextTier?$(e).prop("checked",!1):$(e).prop("checked",a)}))}this.rank();return!1};CSRankings.prototype.sortIndex=function(a){var b=Object.keys(a);b.sort(function(c,d){return a[c]!=a[d]?a[d]-a[c]:c<d?-1:d<c?1:0});return b};
CSRankings.prototype.countAuthorAreas=function(){var a=parseInt($("#fromyear").find(":selected").text()),b=parseInt($("#toyear").find(":selected").text());this.authorAreas={};for(var c in this.authors){var d=this.authors[c].area;if(!(d in CSRankings.nextTier)){var f=this.authors[c].year;if(!(f<a||f>b)){var k=this.authors[c];f=k.name;var e=k.dept;k=parseFloat(k.count);if(!(f in this.authorAreas)){this.authorAreas[f]={};for(var g in this.areaDict)this.areaDict.hasOwnProperty(g)&&(this.authorAreas[f][g]=
0)}if(!(e in this.authorAreas)){this.authorAreas[e]={};for(var h in this.areaDict)this.areaDict.hasOwnProperty(h)&&(this.authorAreas[e][h]=0)}this.authorAreas[f][d]+=k;this.authorAreas[e][d]+=k}}}};
CSRankings.prototype.buildDepartments=function(a,b,c,d,f,k,e,g){var h={},l;for(l in this.authors)if(this.authors.hasOwnProperty(l)){var m=this.authors[l],n=m.dept;if(this.inRegion(n,d)){var p=m.area;if(0!==c[p]){var q=m.year;if(!(q<a||q>b)&&"undefined"!==typeof n){m=m.name;p in CSRankings.parentMap&&(p=CSRankings.parentMap[p]);p+=n;p in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[p]=0);q=parseInt(this.authors[l].count);var r=parseFloat(this.authors[l].adjustedcount);this.areaDeptAdjustedCount[p]+=
r;m in h||(h[m]=!0,e[m]=0,g[m]=0,n in f||(f[n]=0,k[n]=[]),k[n].push(m),f[n]+=1);e[m]+=q;g[m]+=r}}}}};CSRankings.prototype.computeStats=function(a,b,c){this.stats={};for(var d in a)if(a.hasOwnProperty(d)){this.stats[d]=1;for(var f in CSRankings.topLevelAreas){var k=f+d;k in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[k]=0);0!=c[f]&&(this.stats[d]*=this.areaDeptAdjustedCount[k]+1)}this.stats[d]=Math.pow(this.stats[d],1/b)}};
...
CSRankings.prototype.buildDropDown=function(a,b,c){var d=this,f={},k={},e;for(e in a){if(a.hasOwnProperty(e)){var g='<div class="table"><table class="table table-sm table-striped"><thead><th></th><td><small><em><abbr title="Click on an author\'s name to go to their home page.">Faculty</abbr></em></small></td><td align="right"><small><em>&nbsp;&nbsp;<abbr title="Total number of publications (click for DBLP entry).">#&nbsp;Pubs</abbr> </em></small></td><td align="right"><small><em><abbr title="Count divided by number of co-authors">Adj.&nbsp;#</abbr></em></small></td></thead><tbody>';k.$jscomp$loop$prop$fc$27=
{};for(var h=$jscomp.makeIterator(a[e]),l=h.next();!l.done;l=h.next())l=l.value,k.$jscomp$loop$prop$fc$27[l]=b[l];h=Object.keys(k.$jscomp$loop$prop$fc$27);h.sort(function(p){return function(q,r){return p.$jscomp$loop$prop$fc$27[r]===p.$jscomp$loop$prop$fc$27[q]?d.compareNames(q,r):p.$jscomp$loop$prop$fc$27[r]-p.$jscomp$loop$prop$fc$27[q]}}(k));h=$jscomp.makeIterator(h);for(l=h.next();!l.done;l=h.next()){l=l.value;var m=encodeURI(this.homepages[l]),n=this.dblpAuthors[l];g+='<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><small><a title="Click for author\'s home page." target="_blank" href="'+
...
m+'" onclick="trackOutboundLink(\''+m+'\', true); return false;"><img alt="Google Scholar" src="scholar-favicon.ico" height="10" width="10"></a>&nbsp;');g+='<a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+n+"', true); return false;\">";g+='<img alt="DBLP" src="dblp.png"></a>';g+="<span onclick='csr.toggleChart(\""+escape(l)+'");\' title="Click for author\'s publication profile." class="hovertip" id="'+(escape(l)+'-chartwidget">');g+=this.BarChart+
'</span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+n+"', true); return false;\">"+k.$jscomp$loop$prop$fc$27[l]+'</a></small></td><td align="right"><small>'+(Math.round(10*c[l])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div class="csr-barchart" id="'+escape(l)+'-chart"></div></td></tr>'}g+="</tbody></table></div>";f[e]=g}k={$jscomp$loop$prop$fc$27:k.$jscomp$loop$prop$fc$27}}return f};
CSRankings.prototype.buildOutputString=function(a,b,c,d,f){var k=this.makePrologue();k=k+'<thead><tr><th align="left"><font color="#777">#</font></th><th align="left"><font color="#777">Institution</font>'+"&nbsp;".repeat(20)+'</th><th align="right"><abbr title="Geometric mean count of papers published across all areas."><font color="#777">Count</font></abbr></th><th align="right">&nbsp;<abbr title="Number of faculty who have published in these areas."><font color="#777">Faculty</font></abbr></th></th></tr></thead>';
k+="<tbody>";if(0<a){a=1;var e=0,g=9999999.999;for(h in this.stats)this.stats[h]=Math.round(10*this.stats[h])/10;var h=this.sortIndex(this.stats);for(var l=0;l<h.length;l++){var m=h[l],n=this.stats[m];if(l>=f&&n!=g)break;if(0===n)break;g!=n&&(this.useDenseRankings?e+=1:(e+=a,a=0));g=escape(m);k+="\n<tr><td>"+e;k+="&nbsp;".repeat(4-Math.ceil(Math.log10(e)));k+="</td>";k+='<td><span class="hovertip" onclick="csr.toggleFaculty(\''+g+'\');" id="'+g+'-widget">'+this.RightTriangle+"</span>";var p="us";
m in b&&(p=b[m]);k+="&nbsp;"+m+('&nbsp;<img src="/flags/'+p+'.png">&nbsp;<span class="hovertip" onclick="csr.toggleChart(\'')+g+'\');" id="'+g+'-chartwidget">'+this.BarChart+"</span>";k+="</td>";k+='<td align="right">'+(Math.round(10*n)/10).toFixed(1)+"</td>";k+='<td align="right">'+c[m];k+="</td>";k+="</tr>\n";k+='<tr><td colspan="4"><div class="csr-barchart" id="'+g+'-chart"></div></td></tr>';k+='<tr><td colspan="4"><div style="display:none;" id="'+g+'-faculty">'+d[m]+"</div></td></tr>";a++;g=n}k+=
"</tbody></table><br /></div></div>\n<br></body></html>"}else k="<h3>Please select at least one area by clicking one or more checkboxes.</h3>";return k};CSRankings.prototype.setAllOn=function(a){a=void 0===a?!0:a;for(var b=0;b<CSRankings.areas.length;b++){var c=this.fields[b],d="input[name="+c+"]";a?c in CSRankings.nextTier?$(d).prop("checked",!1):($(d).prop("checked",!0),$(d).prop("disabled",!1)):($(d).prop("checked",!1),$(d).prop("disabled",!1))}};
CSRankings.prototype.rank=function(a){a=void 0===a?!0:a;var b=performance.now(),c={},d={},f={},k={},e={};this.areaDeptAdjustedCount={};var g=parseInt($("#fromyear").find(":selected").text()),h=parseInt($("#toyear").find(":selected").text()),l=String($("#regions").find(":selected").val()),m=this.updateWeights(e);this.buildDepartments(g,h,e,l,d,c,f,k);this.computeStats(c,m,e);c=this.buildDropDown(c,f,k);d=this.buildOutputString(m,this.countryAbbrv,d,c,CSRankings.minToRank);m=performance.now();console.log("Before render: rank took "+
...
CSRankings.prototype.toggleChart=function(a){var b=document.getElementById(a+"-chart"),c=document.getElementById(a+"-chartwidget");"block"===b.style.display?(b.style.display="none",b.innerHTML="",c.innerHTML=this.BarChart):(b.style.display="block",this.makeChart(a),c.innerHTML=this.OpenBarChart)};
...
CSRankings.prototype.updatedURL=function(){for(var a="",b=0,c=0,d={},f=0;f<this.fields.length;d={$jscomp$loop$prop$allChecked$29:d.$jscomp$loop$prop$allChecked$29},f++){var k="input[name="+this.fields[f]+"]";this.fields[f]in CSRankings.parentMap||(c+=1);!$(k).prop("checked")||this.fields[f]in CSRankings.parentMap||(d.$jscomp$loop$prop$allChecked$29=1,this.fields[f]in CSRankings.childMap&&CSRankings.childMap[this.fields[f]].forEach(function(h){return function(l){var m=$("input[name="+l+"]").prop("checked");
h.$jscomp$loop$prop$allChecked$29=l in CSRankings.nextTier?h.$jscomp$loop$prop$allChecked$29&(m?0:1):h.$jscomp$loop$prop$allChecked$29&m}}(d)),d.$jscomp$loop$prop$allChecked$29&&(a+=this.fields[f]+"&",b+=1))}0<b&&(a=a.slice(0,-1));d=$("#regions").find(":selected").val();f="";k=(new Date).getFullYear();var e=parseInt($("#fromyear").find(":selected").text()),g=parseInt($("#toyear").find(":selected").text());if(e!=k-10||g!=k)f+="/fromyear/"+e.toString(),f+="/toyear/"+g.toString();f=b==c?f+"/index?all":
...
CSRankings.prototype.navigation=function(a,b){null!==a&&Object.keys(a).forEach(function(e){$("#"+e).prop("value",a[e].toString())});CSRankings.clearNonSubsetted();var c=b.split("&");b=c.some(function(e){return"all"==e});var d=c.some(function(e){return"none"==e});if(c.some(function(e){return 0<=CSRankings.regions.indexOf(e)})){var f=0;c.forEach(function(e){0<=CSRankings.regions.indexOf(e)&&c.splice(f,1);$("#regions").val(e);f+=1})}if(b)for(var k in CSRankings.topTierAreas)b="input[name="+k+"]",$(b).prop("checked",
!0),k in CSRankings.childMap&&($(b).prop("disabled",!1),CSRankings.childMap[k].forEach(function(e){e in CSRankings.nextTier||$("input[name="+e+"]").prop("checked",!0)}));else if(d)CSRankings.clearNonSubsetted();else for(CSRankings.clearNonSubsetted(),k=$jscomp.makeIterator(c),b=k.next();!b.done;b=k.next())b=b.value,"none"!=b&&""!=b&&(d="input[name="+b+"]",$(d).prop("checked",!0),$(d).prop("disabled",!1),b in CSRankings.childMap&&CSRankings.childMap[b].forEach(function(e){e in CSRankings.nextTier||
...
CSRankings.subsetting=function(a){var b=[],c=[];a.forEach(function(k){k in CSRankings.nextTier?c.push(k):b.push(k)});var d=0;b.forEach(function(k){$("input[name="+k+"]").prop("checked")&&d++});var f=0;c.forEach(function(k){$("input[name="+k+"]").prop("checked")&&f++});a=0<f&&0!=c.length;return 0<d&&d<b.length||a};
CSRankings.prototype.addListeners=function(){var a=this;["toyear","fromyear","regions"].forEach(function(e){document.getElementById(e).addEventListener("change",function(){a.countAuthorAreas();a.rank()})});for(var b={},c=0;c<CSRankings.areas.length;b={$jscomp$loop$prop$area$31:b.$jscomp$loop$prop$area$31},c++)if(b.$jscomp$loop$prop$area$31=CSRankings.areas[c],!(b.$jscomp$loop$prop$area$31 in CSRankings.parentMap)){var d=document.getElementById(b.$jscomp$loop$prop$area$31+"-widget");d&&d.addEventListener("click",
function(e){return function(){a.toggleConferences(e.$jscomp$loop$prop$area$31)}}(b))}b={};for(c=0;c<this.fields.length;b={$jscomp$loop$prop$field$33:b.$jscomp$loop$prop$field$33,$jscomp$loop$prop$str$34:b.$jscomp$loop$prop$str$34},c++)b.$jscomp$loop$prop$str$34="input[name="+this.fields[c]+"]",b.$jscomp$loop$prop$field$33=this.fields[c],(d=document.getElementById(this.fields[c]))&&d.addEventListener("click",function(e){return function(){var g=!0;if(e.$jscomp$loop$prop$field$33 in CSRankings.parentMap){g=
!1;var h=CSRankings.parentMap[e.$jscomp$loop$prop$field$33],l="input[name="+h+"]",m=0,n=1;CSRankings.childMap[h].forEach(function(r){var t=$("input[name="+r+"]").prop("checked");m|=t;n=r in CSRankings.nextTier?n&(t?0:1):n&t});$(l).prop("checked",m);m&&!n||$(l).prop("disabled",!1);m&&!n&&$(l).prop("disabled",!0)}else if(h=$(e.$jscomp$loop$prop$str$34).prop("checked"),e.$jscomp$loop$prop$field$33 in CSRankings.childMap){l=$jscomp.makeIterator(CSRankings.childMap[e.$jscomp$loop$prop$field$33]);for(var p=
l.next();!p.done;p=l.next()){p=p.value;var q="input[name="+p+"]";p in CSRankings.nextTier?$(q).prop("checked",!1):$(q).prop("checked",h)}}a.rank(g)}}(b));var f={all_areas_on:function(){a.activateAll()},all_areas_off:function(){a.activateNone()},ai_areas_on:function(){a.activateAI()},ai_areas_off:function(){a.deactivateAI()},systems_areas_on:function(){a.activateSystems()},systems_areas_off:function(){a.deactivateSystems()},theory_areas_on:function(){a.activateTheory()},theory_areas_off:function(){a.deactivateTheory()},
other_areas_on:function(){a.activateOthers()},other_areas_off:function(){a.deactivateOthers()}};b={};for(var k in f)b.$jscomp$loop$prop$item$36=k,document.getElementById(b.$jscomp$loop$prop$item$36).addEventListener("click",function(e){return function(){f[e.$jscomp$loop$prop$item$36]()}}(b)),b={$jscomp$loop$prop$item$36:b.$jscomp$loop$prop$item$36}};CSRankings.minToRank=30;CSRankings.areas=[];CSRankings.topLevelAreas={};CSRankings.topTierAreas={};CSRankings.regions="us europe ca northamerica southamerica australasia asia africa world".split(" ");
