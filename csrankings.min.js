...
var CSRankings=function(){function a(){var b=this;this.authorFile="/csrankings.csv";this.authorinfoFile="/generated-author-info.csv";this.countryinfoFile="/country-info.csv";this.aliasFile="/dblp-aliases.csv";this.turingFile="./turing.csv";this.homepageImage="/house-logo.png";this.allowRankingChange=!1;this.areaMap=[{area:"ai",title:"AI"},{area:"aaai",title:"AI"},{area:"ijcai",title:"AI"},{area:"vision",title:"Vision"},{area:"cvpr",title:"Vision"},{area:"eccv",title:"Vision"},{area:"iccv",title:"Vision"},
...
a+="<br />";e+=1});jQuery("#progress").html(a)};a.prototype.loadAliases=function(b,a){Papa.parse(this.aliasFile,{header:!0,download:!0,complete:function(d){var c=0;for(d=d.data;c<d.length;c++){var e=d[c];b[e.alias]=e.name}setTimeout(a,0)}})};a.prototype.loadTuring=function(b,a){Papa.parse(this.turingFile,{header:!0,download:!0,complete:function(d){var c=0;for(d=d.data;c<d.length;c++){var e=d[c];b[e.name]=e.year}setTimeout(a,0)}})};a.prototype.loadCountryInfo=function(b,a){Papa.parse(this.countryinfoFile,
{header:!0,download:!0,complete:function(d){var c=0;for(d=d.data;c<d.length;c++){var e=d[c];b[e.institution]=e.region}setTimeout(a,0)}})};a.prototype.loadAuthorInfo=function(b){var a=this;Papa.parse(this.authorFile,{download:!0,header:!0,complete:function(d){d=d.data;for(var c=0;c<d.length;c++){var e=d[c],f=e.name;a.homepages[f.trim()]=e.homepage;a.scholarInfo[f.trim()]=e.scholarid}setTimeout(b,0)}})};a.prototype.loadAuthors=function(b){var a=this;Papa.parse(this.authorinfoFile,{download:!0,header:!0,
complete:function(d){a.authors=d.data;setTimeout(b,0)}})};a.prototype.inRegion=function(b,a){switch(a){case "USA":if(b in this.countryInfo)return!1;break;case "europe":if(!(b in this.countryInfo)||"europe"!=this.countryInfo[b])return!1;break;case "canada":if(!(b in this.countryInfo)||"canada"!=this.countryInfo[b])return!1;break;case "northamerica":if(b in this.countryInfo&&"canada"!=this.countryInfo[b])return!1;break;case "australasia":if(!(b in this.countryInfo)||"australasia"!=this.countryInfo[b])return!1;
break;case "southamerica":if(!(b in this.countryInfo)||"southamerica"!=this.countryInfo[b])return!1;break;case "asia":if(!(b in this.countryInfo)||"asia"!=this.countryInfo[b])return!1}return!0};a.prototype.activateFields=function(b,d){for(var e=0;e<d.length;e++){var c=this.fields[d[e]],g="input[name="+c+"]";jQuery(g).prop("checked",b);c in a.childMap&&(jQuery(g).prop("disabled",!1),a.childMap[c].forEach(function(c){c in a.nextTier?jQuery("input[name="+c+"]").prop("checked",!1):jQuery("input[name="+
c+"]").prop("checked",b)}))}this.rank();return!1};a.prototype.sortIndex=function(b){var a=Object.keys(b);a.sort(function(a,c){return b[a]>b[c]?-1:b[c]>b[a]?1:a<c?-1:c<a?1:0});return a};a.prototype.countAuthorAreas=function(b,a){for(var d in this.authors)if(this.authors.hasOwnProperty(d)){var c=this.authors[d],g=c.year;if(!(g<b||g>a)){g=c.area;var f=c.dept,h=parseFloat(c.count);c=c.name;c in this.aliases&&(c=this.aliases[c]);if(!(c in this.authorAreas)){this.authorAreas[c]={};for(var k in this.areaDict)this.areaDict.hasOwnProperty(k)&&
(this.authorAreas[c][k]=0)}if(!(f in this.authorAreas))for(k in this.authorAreas[f]={},this.areaDict)this.areaDict.hasOwnProperty(k)&&(this.authorAreas[f][k]=0);this.authorAreas[c][g]+=h;this.authorAreas[f][g]+=h}}};a.prototype.buildDepartments=function(b,d,e,c,g,f,h,k){var m={},q;for(q in this.authors)if(this.authors.hasOwnProperty(q)){var n=this.authors[q],p=n.name,r=n.year,l=n.area;n=n.dept;p in this.aliases&&(p=this.aliases[p]);if("undefined"!==typeof n&&!(0===e[l]||r<b||r>d)&&this.inRegion(n,
c)){l in a.parentMap&&(l=a.parentMap[l]);r=l+n;l=p+n;r in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[r]=0);var v=parseInt(this.authors[q].count),t=parseFloat(this.authors[q].adjustedcount);this.areaDeptAdjustedCount[r]+=t;p in m||(m[p]=!0,h[l]=0,k[l]=0,n in g||(g[n]=0,f[n]=[]),f[n].push(p),g[n]+=1);h[l]+=v;k[l]+=t}}};a.prototype.computeStats=function(b,d,e){this.stats={};for(var c in b)if(b.hasOwnProperty(c)){this.stats[c]=1;for(var g=0,f=a.areas;g<f.length;g++){var h=f[g];if(!(h in a.parentMap)){var k=
h+c;k in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[k]=0);0!=e[h]&&(this.stats[c]*=this.areaDeptAdjustedCount[k]+1)}}this.stats[c]=Math.pow(this.stats[c],1/d)}};a.prototype.updateWeights=function(b){for(var d=0,e=0;e<a.areas.length;e++){var c=a.areas[e];b[c]=jQuery("input[name="+this.fields[e]+"]").prop("checked")?1:0;1!==b[c]||c in a.parentMap||d++}return d};a.prototype.canonicalizeNames=function(b,a,e){for(var c in b)if(b.hasOwnProperty(c))for(var d=0;d<b[c].length;d++){var f=b[c][d];
f in this.aliases&&(b[c][d]=this.aliases[f],this.aliases[f]+c in a?(a[this.aliases[f]+c]+=a[f+c],e[this.aliases[f]+c]+=e[f+c]):(a[this.aliases[f]+c]=a[f+c],e[this.aliases[f]+c]=e[f+c]))}};a.prototype.buildDropDown=function(b,a,e){var c=this,d={},f=function(f){if(!b.hasOwnProperty(f))return"continue";for(var g='<div class="table"><table class="table table-sm table-striped"><thead><th></th><td><small><em><abbr title="Click on an author\'s name to go to their home page.">Faculty</abbr></em></small></td><td align="right"><small><em>&nbsp;&nbsp;<abbr title="Total number of publications (click for DBLP entry).">#&nbsp;Pubs</abbr></em></small></td><td align="right"><small><em><abbr title="Count divided by number of co-authors">Adj.&nbsp;#</abbr></em></small></td></thead><tbody>',
...
h.turing.hasOwnProperty(l)&&(g+="<b>[Turing Award winner]</b>&nbsp;");g+='<a title="Click for author\'s home page." target="_blank" href="'+m+'" onclick="trackOutboundLink(\''+m+'\', true); return false;"><img src="'+h.homepageImage+'"></a>&nbsp;';h.scholarInfo.hasOwnProperty(l)&&"NOSCHOLARPAGE"!=h.scholarInfo[l]&&(m="https://scholar.google.com/citations?user="+h.scholarInfo[l]+"&hl=en&oi=ao",g+='<a title="Click for author\'s Google Scholar page." target="_blank" href="'+m+'" onclick="trackOutboundLink(\''+
m+'\', true); return false;"><img src="scholar-favicon.ico" height="10" width="10"></a>&nbsp;');g+='<a title="Click for author\'s DBLP entry." target="_blank" href="'+t+'" onclick="trackOutboundLink(\''+t+'\', true); return false;"><img src="dblp.png"></a>';g+="<span onclick='csr.toggleChart(\""+escape(l)+'");\' title="Click for author\'s publication profile." class="hovertip" ><font color="blue">'+h.PieChart+'</font></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+
t+'" onclick="trackOutboundLink(\''+t+"', true); return false;\">"+k[l]+'</a></small></td><td align="right"><small>'+(Math.round(10*e[l+f])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(l)+'-chart"></div></td></tr>'}d[f]=g+"</tbody></table></div>"},h=this,k;for(k in b)f(k);return d};a.prototype.buildOutputString=function(b,a,e){var c=this.makePrologue();c+='<thead><tr><th align="left">Rank&nbsp;&nbsp;</th><th align="right">Institution&nbsp;&nbsp;</th><th align="right"><abbr title="Geometric mean count of papers published across all areas.">Count</abbr></th><th align="right">&nbsp;<abbr title="Number of faculty who have published in these areas.">Faculty</abbr></th></th></tr></thead><tbody>';
