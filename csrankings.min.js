...
CSRankings.prototype.countAuthorAreas=function(a,b){for(var d in this.authors)if(this.authors.hasOwnProperty(d)){var c=this.authors[d],f=c.name,e=c.year,h=c.area,k=c.dept;if(!(e<a||e>b||h in CSRankings.nextTier)){c=parseFloat(c.count);f in this.aliases&&(f=this.aliases[f]);if(!(f in this.authorAreas)){this.authorAreas[f]={};for(var l in this.areaDict)this.areaDict.hasOwnProperty(l)&&(this.authorAreas[f][l]=0)}if(!(k in this.authorAreas)){this.authorAreas[k]={};for(var g in this.areaDict)this.areaDict.hasOwnProperty(g)&&
(this.authorAreas[k][g]=0)}this.authorAreas[f][h]+=c;this.authorAreas[k][h]+=c}}};
CSRankings.prototype.buildDepartments=function(a,b,d,c,f,e,h,k){var l={},g;for(g in this.authors)if(this.authors.hasOwnProperty(g)){var m=this.authors[g],n=m.name,q=m.year,p=m.area;m=m.dept;if(!(0===d[p]||q<a||q>b)&&this.inRegion(m,c)&&"undefined"!==typeof m){n in this.aliases&&(n=this.aliases[n]);p in CSRankings.parentMap&&(p=CSRankings.parentMap[p]);q=p+m;p=n+m;q in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[q]=0);var t=parseInt(this.authors[g].count),r=parseFloat(this.authors[g].adjustedcount);
