...
n+'\', true); return false;"><img src="dblp.png"></a>';l+="<span onclick='csr.toggleChart(\""+escape(g)+'");\' title="Click for author\'s publication profile." class="hovertip" id="'+escape(g)+'-chartwidget"><font size="+1">'+this.PieChart+'</font></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+n+"', true); return false;\">"+f.fc[g]+'</a></small></td><td align="right"><small>'+(Math.round(10*d[g])/
10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(g)+'-chart"></div></td></tr>'}l+="</tbody></table></div>";e[h]=l}f={fc:f.fc}}return e};
