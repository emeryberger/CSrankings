...
e+="</div></div>\n<br></body></html>"}else e="<h4>Please select at least one area.</h4>";return e};a.setAllCheckboxes=function(){a.activateAll()};a.rank=function(){var b={},c={},d={},f={},h={};a.areaDeptAdjustedCount={};var e=parseInt(jQuery("#startyear").find(":selected").text()),g=parseInt(jQuery("#endyear").find(":selected").text()),l=jQuery("#regions").find(":selected").val(),q=a.updateWeights(h);a.authorAreas={};a.countAuthorAreas(a.authors,e,g,a.authorAreas);a.buildDepartments(a.authors,e,g,
h,l,a.areaDeptAdjustedCount,c,b,d,f);a.stats=a.computeStats(b,a.areaDeptAdjustedCount,a.areas,q,!0,h);a.canonicalizeNames(b,d,f);b=a.buildDropDown(b,d,f);var k=a.buildOutputString(!0,q,a.stats,c,b);setTimeout(function(){jQuery("#success").html(k);a.urlUpdate()},0);return!1};a.toggleChart=function(b){var c=document.getElementById(b+"-chart");"block"===c.style.display?(c.style.display="none",c.innerHTML=""):(c.style.display="block",a.makeChart(b))};a.toggleConferences=function(b){var c=document.getElementById(b+
...
a.addListeners=function(){for(var b=this,c=function(b){var c=a.areas[b];document.getElementById(c+"-widget").addEventListener("click",function(){a.toggleConferences(c)})},d=0;d<a.areas.length;d++)c(d);for(c=0;c<a.fields.length;c++)jQuery("input[name="+a.fields[c]+"]").click(function(){b.rank()})};return a}();CSRankings.authorinfoFile="/generated-author-info.csv";CSRankings.countryinfoFile="/country-info.csv";CSRankings.aliasFile="/dblp-aliases.csv";CSRankings.homepagesFile="/homepages.csv";
CSRankings.scholarFile="/scholar.csv";CSRankings.allowRankingChange=!1;CSRankings.parentMap={aaai:"ai",ijcai:"ai",cvpr:"vision",eccv:"vision",iccv:"vision"};CSRankings.childMap={ai:["aaai","ijcai"],vision:["cvpr","eccv","iccv"]};
