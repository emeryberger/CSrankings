...
k.$jscomp$loop$prop$allChecked$30=l in CSRankings.nextTier?k.$jscomp$loop$prop$allChecked$30&(m?0:1):k.$jscomp$loop$prop$allChecked$30&m}}(d)),d.$jscomp$loop$prop$allChecked$30&&(a+=this.fields[f]+"&",b+=1))}0<b&&(a=a.slice(0,-1));d=$("#regions").find(":selected").val();f="";h=(new Date).getFullYear();var e=parseInt($("#fromyear").find(":selected").text()),g=parseInt($("#toyear").find(":selected").text());if(e!=h-10||g!=h)f+="/fromyear/"+e.toString(),f+="/toyear/"+g.toString();"pie"==$("#charttype").find(":selected").val()?
(this.usePieChart=!0,f+="/chart/pie"):this.usePieChart=!1;f=b==c?f+"/index?all":0==b?f+"/index?none":f+("/index?"+a);"USA"!=d&&(f+="&"+d);return f};CSRankings.geoCheck=function(){navigator.geolocation.getCurrentPosition(function(a){a=whichContinent(a.coords.latitude,a.coords.longitude);var b=document.getElementById("regions");switch(a){case "northamerica":return;case "europe":case "asia":case "southamerica":case "africa":b.value=a;break;default:b.value="world"}CSRankings.getInstance().rank()})};
