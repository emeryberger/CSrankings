...
return this.areaStringMap[a]}compareNames(a,c){a=a.split(" ");c=c.split(" ");a=a[a.length-1];c=c[c.length-1];return a<c?-1:a>c?1:0}makeChart(a,c){let d=[],b={};var e=CSRankings.topTierAreas,g=unescape(a),f=[...this.aiAreas.map(h=>({key:h,label:this.areaDict[h],color:"#377eb8"})),...this.systemsAreas.map(h=>({key:h,label:this.areaDict[h],color:"#ff7f00"})),...this.theoryAreas.map(h=>({key:h,label:this.areaDict[h],color:"#4daf4a"})),...this.interdisciplinaryAreas.map(h=>({key:h,label:this.areaDict[h],
color:"#984ea3"}))];f.forEach(h=>b[h.key]=0);for(let h in e){if(!(g in this.authorAreas))return;e=Math.round(10*this.authorAreas[g][h])/10;0<e&&(h in CSRankings.parentMap&&(h=CSRankings.parentMap[h]),b[h]+=e)}let l=0;f.forEach(h=>{l+=b[h.key]});f.forEach((h,k)=>{d.push({index:k,area:this.areaDict[h.key],value:Math.round(10*b[h.key])/10,ratio:b[h.key]/l});h.label=this.areaDict[h.key]});f=f.sort((h,k)=>h.label>k.label?1:h.label<k.label?-1:0).map(h=>h.color);g={$schema:"https://vega.github.io/schema/vega-lite/v5.json",
data:{values:d},mark:"bar",encoding:{x:{field:"area",type:"nominal",sort:null,axis:{title:null}},y:{field:"value",type:"quantitative",axis:{title:null}},tooltip:[{field:"area",type:"nominal",title:"Area"},{field:"value",type:"quantitative",title:"Count"}],color:{field:"area",type:"nominal",scale:{range:f},legend:null}},width:420,height:80,padding:{left:25,top:3}};f={$schema:"https://vega.github.io/schema/vega-lite/v5.json",data:{values:d},encoding:{theta:{field:"value",type:"quantitative",stack:!0},
color:{field:"area",type:"nominal",scale:{range:f},legend:null},order:{field:"index"},tooltip:[{field:"area",type:"nominal",title:"Area"},{field:"value",type:"quantitative",title:"Count"},{field:"ratio",type:"quantitative",title:"Ratio",format:".1%"}]},layer:[{mark:{type:"arc",outerRadius:90,stroke:"#fdfdfd",strokeWidth:1}},{mark:{type:"text",radius:108,dy:-3},encoding:{text:{field:"area",type:"nominal"},color:{condition:{test:"datum.ratio < 0.03",value:"rgba(255, 255, 255, 0)"},field:"area",type:"nominal",
scale:{range:f}}}},{mark:{type:"text",radius:108,fontSize:9,dy:7},encoding:{text:{field:"value",type:"quantitative"},color:{condition:{test:"datum.ratio < 0.03",value:"rgba(255, 255, 255, 0)"},field:"area",type:"nominal",scale:{range:f}}}}],width:400,height:250,padding:{left:25,top:3}};vegaEmbed(`div[id="${a}-chart"]`,c?f:g,{actions:!1})}displayProgress(a){a=`<strong>${["Initializing.","Loading author information.","Loading publication data.","Computing ranking."][a-1]}</strong><br />`;const c=document.querySelector("#progress");
c&&(c.innerHTML=a)}loadTuring(a){return __awaiter(this,void 0,void 0,function*(){const c=yield new Promise(d=>{Papa.parse(this.turingFile,{header:!0,download:!0,complete:b=>{d(b.data)}})});for(const d of c)a[d.name]=d.year})}loadACMFellow(a){return __awaiter(this,void 0,void 0,function*(){const c=yield new Promise(d=>{Papa.parse(this.acmfellowFile,{header:!0,download:!0,complete:b=>{d(b.data)}})});for(const d of c)a[d.name]=d.year})}loadCountryInfo(a,c){return __awaiter(this,void 0,void 0,function*(){const d=
yield new Promise(b=>{Papa.parse(this.countryinfoFile,{header:!0,download:!0,complete:e=>{b(e.data)}})});for(const b of d)a[b.institution]=b.region,c[b.institution]=b.countryabbrv})}loadAuthorInfo(){return __awaiter(this,void 0,void 0,function*(){const a=yield new Promise(c=>{Papa.parse(this.authorFile,{download:!0,header:!0,complete:d=>{c(d.data)}})});for(let c=0;c<a.length;c++){const d=a[c];let b=d.name.trim();const e=b.match(CSRankings.nameMatcher);e&&(b=e[1].trim(),this.note[b]=e[2]);""!==b&&
(this.dblpAuthors[b]=this.translateNameToDBLP(b),this.homepages[b]=d.homepage,this.scholarInfo[b]=d.scholarid)}})}loadAuthors(){return __awaiter(this,void 0,void 0,function*(){this.authors=yield new Promise(a=>{Papa.parse(this.authorinfoFile,{download:!0,header:!0,complete:c=>{a(c.data)}})})})}inRegion(a,c){switch(c){case "us":if(a in this.countryInfo)return!1;break;case "at":case "au":case "br":case "ca":case "ch":case "cn":case "de":case "dk":case "es":case "fr":case "gr":case "hk":case "il":case "in":case "it":case "jp":case "kr":case "nl":case "nz":case "tr":case "uk":if(this.countryAbbrv[a]!=
c)return!1;break;case "europe":if(!(a in this.countryInfo)||"europe"!=this.countryInfo[a])return!1;break;case "northamerica":if(a in this.countryInfo&&"canada"!=this.countryInfo[a])return!1;break;case "australasia":if(!(a in this.countryInfo)||"australasia"!=this.countryInfo[a])return!1;break;case "southamerica":if(!(a in this.countryInfo)||"southamerica"!=this.countryInfo[a])return!1;break;case "asia":if(!(a in this.countryInfo)||"asia"!=this.countryInfo[a])return!1;break;case "africa":if(!(a in
this.countryInfo)||"africa"!=this.countryInfo[a])return!1}return!0}activateFields(a,c){for(let d=0;d<c.length;d++){const b=this.fields[c[d]],e=`input[name=${b}]`;$(e).prop("checked",a);b in CSRankings.childMap&&($(e).prop("disabled",!1),CSRankings.childMap[b].forEach(g=>{const f=`input[name=${g}]`;g in CSRankings.nextTier?$(f).prop("checked",!1):$(f).prop("checked",a)}))}this.rank();return!1}sortIndex(a){let c=Object.keys(a);c.sort((d,b)=>a[d]!=a[b]?a[b]-a[d]:d<b?-1:b<d?1:0);return c}countAuthorAreas(){const a=
parseInt($("#fromyear").find(":selected").text()),c=parseInt($("#toyear").find(":selected").text());this.authorAreas={};for(const b in this.authors){const {area:e}=this.authors[b];if(e in CSRankings.nextTier)continue;var {year:d}=this.authors[b];if(d<a||d>c)continue;const {name:g,dept:f,count:l}=this.authors[b];d=parseFloat(l);if(!(g in this.authorAreas)){this.authorAreas[g]={};for(const h in this.areaDict)this.areaDict.hasOwnProperty(h)&&(this.authorAreas[g][h]=0)}if(!(f in this.authorAreas)){this.authorAreas[f]=
{};for(const h in this.areaDict)this.areaDict.hasOwnProperty(h)&&(this.authorAreas[f][h]=0)}this.authorAreas[g][e]+=d;this.authorAreas[f][e]+=d}}buildDepartments(a,c,d,b,e,g,f,l){const h={};for(const q in this.authors){if(!this.authors.hasOwnProperty(q))continue;var k=this.authors[q];const p=k.dept;if(!this.inRegion(p,b))continue;var m=k.area;if(0===d[m])continue;var n=k.year;if(n<a||n>c)continue;if("undefined"===typeof p)continue;k=k.name;m in CSRankings.parentMap&&(m=CSRankings.parentMap[m]);m+=
p;m in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[m]=0);n=parseInt(this.authors[q].count);const r=parseFloat(this.authors[q].adjustedcount);this.areaDeptAdjustedCount[m]+=r;k in h||(h[k]=!0,f[k]=0,l[k]=0,p in e||(e[p]=0,g[p]=[]),g[p].push(k),e[p]+=1);f[k]+=n;l[k]+=r}}computeStats(a,c,d){this.stats={};for(const b in a)if(a.hasOwnProperty(b)){this.stats[b]=1;for(const e in CSRankings.topLevelAreas){const g=e+b;g in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[g]=0);0!=d[e]&&
...
let d=c.split("&");c=d.some(f=>"all"==f);d.some(f=>"survey"==f)&&(document.getElementById("overlay-survey").style.display="block");const b=d.some(f=>"none"==f);if(d.some(f=>0<=CSRankings.regions.indexOf(f))){let f=0;d.forEach(l=>{0<=CSRankings.regions.indexOf(l)&&(d.splice(f,1),$("#regions").val(l));f+=1})}d.some(f=>"pie"==f)&&$("#charttype").val("pie");if(c)for(var e in CSRankings.topTierAreas){var g=`input[name=${e}]`;$(g).prop("checked",!0);e in CSRankings.childMap&&($(g).prop("disabled",!1),CSRankings.childMap[e].forEach(f=>
{f in CSRankings.nextTier||$(`input[name=${f}]`).prop("checked",!0)}))}else if(b)CSRankings.clearNonSubsetted();else{CSRankings.clearNonSubsetted();for(g of d)"none"!=g&&""!=g&&(e=`input[name=${g}]`,$(e).prop("checked",!0),$(e).prop("disabled",!1),g in CSRankings.childMap&&CSRankings.childMap[g].forEach(f=>{f in CSRankings.nextTier||$(`input[name=${f}]`).prop("checked",!0)}))}}static clearNonSubsetted(){for(const a of CSRankings.areas)if(a in CSRankings.childMap){const c=CSRankings.childMap[a];if(!CSRankings.subsetting(c)){const d=
`input[name=${a}]`;$(d).prop("checked",!1);$(d).prop("disabled",!1);c.forEach(b=>{$(`input[name=${b}]`).prop("checked",!1)})}}}static subsetting(a){let c=[],d=[];a.forEach(g=>{g in CSRankings.nextTier?d.push(g):c.push(g)});let b=0;c.forEach(g=>{$(`input[name=${g}]`).prop("checked")&&b++});let e=0;d.forEach(g=>{$(`input[name=${g}]`).prop("checked")&&e++});a=0<e&&0!=d.length;return 0<b&&b<c.length||a}addListeners(){["toyear","fromyear","regions","charttype"].forEach(b=>{document.getElementById(b).addEventListener("change",
()=>{this.countAuthorAreas();this.rank()})});for(var a=0;a<CSRankings.areas.length;a++){let b=CSRankings.areas[a];if(!(b in CSRankings.parentMap)){var c=document.getElementById(`${b}-widget`);c&&c.addEventListener("click",()=>{this.toggleConferences(b)})}}for(a=0;a<this.fields.length;a++){const b=`input[name=${this.fields[a]}]`,e=this.fields[a];(c=document.getElementById(this.fields[a]))&&c.addEventListener("click",()=>{let g=!0;if(e in CSRankings.parentMap){g=!1;let f=0,l=1;CSRankings.childMap[CSRankings.parentMap[e]].forEach(h=>
{const k=$(`input[name=${h}]`).prop("checked");f|=k;l=h in CSRankings.nextTier?l&(k?0:1):l&k});$("input[name={parent}]").prop("checked",f);f&&!l||$("input[name={parent}]").prop("disabled",!1);f&&!l&&$("input[name={parent}]").prop("disabled",!0)}else{const f=$(b).prop("checked");if(e in CSRankings.childMap)for(const l of CSRankings.childMap[e]){const h=`input[name=${l}]`;l in CSRankings.nextTier?$(h).prop("checked",!1):$(h).prop("checked",f)}}this.rank(g)})}const d={all_areas_on:()=>{this.activateAll()},
all_areas_off:()=>{this.activateNone()},ai_areas_on:()=>{this.activateAI()},ai_areas_off:()=>{this.deactivateAI()},systems_areas_on:()=>{this.activateSystems()},systems_areas_off:()=>{this.deactivateSystems()},theory_areas_on:()=>{this.activateTheory()},theory_areas_off:()=>{this.deactivateTheory()},other_areas_on:()=>{this.activateOthers()},other_areas_off:()=>{this.deactivateOthers()}};for(const b in d)document.getElementById(b).addEventListener("click",()=>{d[b]()})}}CSRankings.minToRank=30;
CSRankings.areas=[];CSRankings.topLevelAreas={};CSRankings.topTierAreas={};CSRankings.regions="europe northamerica southamerica australasia asia africa world au at br ca cn dk fr de gr hk in il it jp nl nz kr es ch tr uk us".split(" ");CSRankings.nameMatcher=RegExp("(.*)\\s+\\[(.*)\\]");CSRankings.parentIndex={};
