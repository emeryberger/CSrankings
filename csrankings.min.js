...
h.turing.hasOwnProperty(l)&&(g+="<b>[Turing Award winner]</b>&nbsp;");if(h.scholarInfo.hasOwnProperty(l)&&"NOSCHOLARPAGE"!=h.scholarInfo[l]){var u="https://scholar.google.com/citations?user="+h.scholarInfo[l]+"&hl=en&oi=ao";g+='<a title="Click for author\'s Google Scholar page." target="_blank" href="'+u+'" onclick="trackOutboundLink(\''+u+'\', true); return false;"><img src="scholar-favicon.ico" height="10" width="10"></a>&nbsp;'}g+='<a title="Click for author\'s home page." target="_blank" href="'+
m+'" onclick="trackOutboundLink(\''+m+'\', true); return false;"><img src="'+h.homepageImage+'"></a>&nbsp;';g+="<span onclick='csr.toggleChart(\""+escape(l)+'");\' title="Click for author\'s publication profile." class="hovertip" ><font color="blue">'+h.PieChart+'</font></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+t+'" onclick="trackOutboundLink(\''+t+"', true); return false;\">"+k[l]+'</a></small></td><td align="right"><small>'+(Math.round(10*
e[l+f])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(l)+'-chart"></div></td></tr>'}d[f]=g+"</tbody></table></div>"},h=this,k;for(k in b)f(k);return d};a.prototype.buildOutputString=function(b,a,e){var c=this.makePrologue();c+='<thead><tr><th align="left">Rank&nbsp;&nbsp;</th><th align="right">Institution&nbsp;&nbsp;</th><th align="right"><abbr title="Geometric mean count of papers published across all areas.">Count</abbr></th><th align="right">&nbsp;<abbr title="Number of faculty who have published in these areas.">Faculty</abbr></th></th></tr></thead><tbody>';
