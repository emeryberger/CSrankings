...
k+"', true); return false;\">"+g+"</a>&nbsp;";this.acmfellow.hasOwnProperty(g)&&(l+='<span title="ACM Fellow"><img src="'+this.acmfellowImage+'"></span>&nbsp;');this.turing.hasOwnProperty(g)&&(l+='<span title="Turing Award"><img src="'+this.turingImage+'"></span>&nbsp;');l+='<font style="font-variant:small-caps" size="-1">'+this.areaString(g).toLowerCase()+"</em></font>&nbsp;";l+='<a title="Click for author\'s home page." target="_blank" href="'+k+'" onclick="trackOutboundLink(\''+k+'\', true); return false;"><img src="'+
this.homepageImage+'"></a>&nbsp;';this.scholarInfo.hasOwnProperty(g)&&"NOSCHOLARPAGE"!=this.scholarInfo[g]&&(k="https://scholar.google.com/citations?user="+this.scholarInfo[g]+"&hl=en&oi=ao",l+='<a title="Click for author\'s Google Scholar page." target="_blank" href="'+k+'" onclick="trackOutboundLink(\''+k+'\', true); return false;"><img src="scholar-favicon.ico" height="10" width="10"></a>&nbsp;');l+='<a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+
n+'\', true); return false;"><img src="dblp.png"></a>';l+="<span onclick='csr.toggleChart(\""+escape(g)+'");\' title="Click for author\'s publication profile." class="hovertip" ><font size="+1" color="blue">'+this.PieChart+'</font></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+n+"', true); return false;\">"+f.fc[g]+'</a></small></td><td align="right"><small>'+(Math.round(10*d[g])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+
escape(g)+'-chart"></div></td></tr>'}l+="</tbody></table></div>";e[h]=l}f={fc:f.fc}}return e};
...
CSRankings.prototype.rank=function(a){a=void 0===a?!0:a;var b={},d={},c={},e={},f={};this.areaDeptAdjustedCount={};var h=parseInt(jQuery("#fromyear").find(":selected").text()),l=parseInt(jQuery("#toyear").find(":selected").text()),m=jQuery("#regions").find(":selected").val(),g=this.updateWeights(f);this.buildDepartments(h,l,f,m,d,b,c,e);this.computeStats(b,g,f);b=this.buildDropDown(b,c,e);d=this.buildOutputString(g,d,b);jQuery("#success").html(d);a?this.navigoRouter.resume():this.navigoRouter.pause();
