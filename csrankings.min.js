...
a.getInstance().rank();break;default:jQuery("#regions").val("world"),a.getInstance().rank()}})};a.prototype.navigation=function(b,d){null!==b&&Object.keys(b).forEach(function(a){jQuery("#"+a).prop("value",b[a].toString())});a.clearNonSubsetted();var e=d.split("&");d=e.some(function(a){return"all"==a});var c=e.some(function(a){return"none"==a});if(e.some(function(b){return 0<=a.regions.indexOf(b)})){var g=0;e.forEach(function(b){0<=a.regions.indexOf(b)&&e.splice(g,1);jQuery("#regions").val(b);g+=1})}if(d)for(var f=
0;f<a.areas.length;f++)d=a.areas[f],d in a.nextTier||(c="input[name="+d+"]",jQuery(c).prop("checked",!0),d in a.childMap&&(jQuery(c).prop("disabled",!1),a.childMap[d].forEach(function(b){b in a.nextTier||jQuery("input[name="+b+"]").prop("checked",!0)})));else if(c)a.clearNonSubsetted();else for(a.clearNonSubsetted(),f=0;f<e.length;f++)d=e[f],"none"!=d&&""!=d&&(c="input[name="+d+"]",jQuery(c).prop("checked",!0),jQuery(c).prop("disabled",!1),d in a.childMap&&a.childMap[d].forEach(function(b){b in a.nextTier||
jQuery("input[name="+b+"]").prop("checked",!0)}))};a.clearNonSubsetted=function(){for(var b=0,d=a.areas;b<d.length;b++){var e=d[b];if(e in a.childMap){var c=a.childMap[e];a.subsetting(c)||(e="input[name="+e+"]",jQuery(e).prop("checked",!1),jQuery(e).prop("disabled",!1),c.forEach(function(a){jQuery("input[name="+a+"]").prop("checked",!1)}))}}};a.subsetting=function(b){var d=[],e=[];b.forEach(function(b){b in a.nextTier?e.push(b):d.push(b)});var c=0;d.forEach(function(a){jQuery("input[name="+a+"]").prop("checked")&&
c++});var g=0;e.forEach(function(a){jQuery("input[name="+a+"]").prop("checked")&&g++});b=0<g&&0!=e.length;return 0<c&&c<d.length||b};a.prototype.addListeners=function(){var b=this;["toyear","fromyear","regions"].forEach(function(a){document.getElementById(a).addEventListener("change",function(){b.rank()})});var d=function(c){var d=a.areas[c];d in a.parentMap||document.getElementById(d+"-widget").addEventListener("click",function(){b.toggleConferences(d)})},e=0;for(;e<a.areas.length;e++)d(e);d=function(d){var e=
"input[name="+c.fields[d]+"]",f=c.fields[d];jQuery(e).click(function(){var c=!0;if(f in a.parentMap){c=!1;var d=a.parentMap[f],g="input[name="+d+"]",h=0,k=1;a.childMap[d].forEach(function(b){var c=jQuery("input[name="+b+"]").prop("checked");h|=c;k=b in a.nextTier?k&(c?0:1):k&c});jQuery(g).prop("checked",h);h&&!k||jQuery(g).prop("disabled",!1);h&&!k&&jQuery(g).prop("disabled",!0)}else if(d=jQuery(e).prop("checked"),f in a.childMap){g=0;for(var m=a.childMap[f];g<m.length;g++){var t=m[g],u="input[name="+
t+"]";t in a.nextTier?jQuery(u).prop("checked",!1):jQuery(u).prop("checked",d)}}b.rank(c)})};var c=this;for(e=0;e<this.fields.length;e++)d(e);var g={all_areas_on:function(){b.activateAll()},all_areas_off:function(){b.activateNone()},ai_areas_on:function(){b.activateAI()},ai_areas_off:function(){b.deactivateAI()},systems_areas_on:function(){b.activateSystems()},systems_areas_off:function(){b.deactivateSystems()},theory_areas_on:function(){b.activateTheory()},theory_areas_off:function(){b.deactivateTheory()},
other_areas_on:function(){b.activateOthers()},other_areas_off:function(){b.deactivateOthers()}};d=function(a){document.getElementById(a).addEventListener("click",function(){g[a]()})};for(var f in g)d(f)};a.areas=[];a.regions="USA europe canada northamerica southamerica australasia asia world".split(" ");a.parentMap={aaai:"ai",ijcai:"ai",cvpr:"vision",eccv:"vision",iccv:"vision",icml:"mlmining",kdd:"mlmining",nips:"mlmining",acl:"nlp",emnlp:"nlp",naacl:"nlp",sigir:"ir",www:"ir",asplos:"arch",isca:"arch",
micro:"arch",hpca:"arch",ccs:"sec",oakland:"sec",usenixsec:"sec",ndss:"sec",pets:"sec",vldb:"mod",sigmod:"mod",icde:"mod",pods:"mod",dac:"da",iccad:"da",emsoft:"bed",rtas:"bed",rtss:"bed",sc:"hpc",hpdc:"hpc",ics:"hpc",mobicom:"mobile",mobisys:"mobile",sensys:"mobile",imc:"metrics",sigmetrics:"metrics",osdi:"ops",sosp:"ops",eurosys:"ops",fast:"ops",usenixatc:"ops",popl:"plan",pldi:"plan",oopsla:"plan",icfp:"plan",fse:"soft",icse:"soft",ase:"soft",issta:"soft",nsdi:"comm",sigcomm:"comm",siggraph:"graph",
"siggraph-asia":"graph",focs:"act",soda:"act",stoc:"act",crypto:"crypt",eurocrypt:"crypt",cav:"log",lics:"log",ismb:"bio",recomb:"bio",ec:"ecom",wine:"ecom",chiconf:"chi",ubicomp:"chi",uist:"chi",icra:"robotics",iros:"robotics",rss:"robotics",vis:"visualization",vr:"visualization"};a.nextTier={ase:!0,issta:!0,icde:!0,pods:!0,hpca:!0,ndss:!0,pets:!0,fast:!0,usenixatc:!0,icfp:!0,oopsla:!0};a.childMap={};return a}(),csr=new CSRankings;
