...
{area:"rtas",title:"Embedded"},{area:"rtss",title:"Embedded"},{area:"visualization",title:"Visualization"},{area:"vis",title:"Visualization"},{area:"vr",title:"Visualization"},{area:"ecom",title:"ECom"},{area:"ec",title:"ECom"},{area:"wine",title:"ECom"}];this.aiAreas=["ai","vision","mlmining","nlp","ir"];this.systemsAreas="arch comm sec mod hpc mobile metrics ops plan soft da bed".split(" ");this.theoryAreas=["act","crypt","log"];this.interdisciplinaryAreas="graph chi robotics bio visualization ecom".split(" ");
...
a.displayProgress(4);a.countAuthorAreas();a.loadCountryInfo(a.countryInfo,function(){setTimeout(function(){a.addListeners();CSRankings.getInstance().rank()},0)})})})})})};CSRankings.updateMinimum=function(a){return 500>=CSRankings.minToRank?(a=a.scrollTop,CSRankings.minToRank=5E3,CSRankings.getInstance().rank(),a):0};CSRankings.getInstance=function(){return CSRankings.theInstance};CSRankings.promise=function(a){"undefined"!==typeof Promise?Promise.resolve().then(a):setTimeout(a,0)};
...
CSRankings.prototype.loadAuthorInfo=function(a){var b=this;Papa.parse(this.authorFile,{download:!0,header:!0,complete:function(d){d=d.data;for(var c=0;c<d.length;c++){var e=d[c],f=e.name.trim(),g=f.match(CSRankings.nameMatcher);g&&(f=g[1].trim(),b.note[f]=g[2]);""!==f&&(b.dblpAuthors[f]=b.translateNameToDBLP(f),b.homepages[f]=e.homepage,b.scholarInfo[f]=e.scholarid)}CSRankings.promise(a)}})};
CSRankings.prototype.loadAuthors=function(a){var b=this;Papa.parse(this.authorinfoFile,{download:!0,header:!0,complete:function(d){b.authors=d.data;CSRankings.promise(a)}})};
...
CSRankings.prototype.countAuthorAreas=function(){var a=parseInt($("#fromyear").find(":selected").text()),b=parseInt($("#toyear").find(":selected").text());this.authorAreas={};for(var d in this.authors){var c=this.authors[d].area;if(!(c in CSRankings.nextTier)){var e=this.authors[d].year;if(!(e<a||e>b)){var f=this.authors[d];e=f.name;var g=f.dept;f=parseFloat(f.count);if(!(e in this.authorAreas)){this.authorAreas[e]={};for(var l in this.areaDict)this.areaDict.hasOwnProperty(l)&&(this.authorAreas[e][l]=
0)}if(!(g in this.authorAreas)){this.authorAreas[g]={};for(var m in this.areaDict)this.areaDict.hasOwnProperty(m)&&(this.authorAreas[g][m]=0)}this.authorAreas[e][c]+=f;this.authorAreas[g][c]+=f}}}};
CSRankings.prototype.buildDepartments=function(a,b,d,c,e,f,g,l){var m={},h;for(h in this.authors)if(this.authors.hasOwnProperty(h)){var k=this.authors[h],n=k.dept;if(this.inRegion(n,c)){var p=k.area;if(0!==d[p]){var q=k.year;if(!(q<a||q>b)&&"undefined"!==typeof n){k=k.name;p in CSRankings.parentMap&&(p=CSRankings.parentMap[p]);p+=n;p in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[p]=0);q=parseInt(this.authors[h].count);var r=parseFloat(this.authors[h].adjustedcount);this.areaDeptAdjustedCount[p]+=
r;k in m||(m[k]=!0,g[k]=0,l[k]=0,n in e||(e[n]=0,f[n]=[]),f[n].push(k),e[n]+=1);g[k]+=q;l[k]+=r}}}}};CSRankings.prototype.computeStats=function(a,b,d){this.stats={};for(var c in a)if(a.hasOwnProperty(c)){this.stats[c]=1;for(var e in CSRankings.topLevelAreas){var f=e+c;f in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[f]=0);0!=d[e]&&(this.stats[c]*=this.areaDeptAdjustedCount[f]+1)}this.stats[c]=Math.pow(this.stats[c],1/b)}};
...
CSRankings.prototype.buildDropDown=function(a,b,d){var c=this,e={},f={},g;for(g in a){if(a.hasOwnProperty(g)){var l='<div class="table"><table class="table table-sm table-striped"><thead><th></th><td><small><em><abbr title="Click on an author\'s name to go to their home page.">Faculty</abbr></em></small></td><td align="right"><small><em>&nbsp;&nbsp;<abbr title="Total number of publications (click for DBLP entry).">#&nbsp;Pubs</abbr> </em></small></td><td align="right"><small><em><abbr title="Count divided by number of co-authors">Adj.&nbsp;#</abbr></em></small></td></thead><tbody>';f.fc=
{};for(var m=$jscomp.makeIterator(a[g]),h=m.next();!h.done;h=m.next())h=h.value,f.fc[h]=b[h];m=Object.keys(f.fc);m.sort(function(a){return function(b,d){return a.fc[d]===a.fc[b]?c.compareNames(b,d):a.fc[d]-a.fc[b]}}(f));m=$jscomp.makeIterator(m);for(h=m.next();!h.done;h=m.next()){h=h.value;var k=encodeURI(this.homepages[h]),n=this.dblpAuthors[h];l+='<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><small><a title="Click for author\'s home page." target="_blank" href="'+k+'" onclick="trackOutboundLink(\''+
k+"', true); return false;\">"+h+"</a>&nbsp;";this.note.hasOwnProperty(h)&&(l+='<span class="note" title="Note">['+('<a href="'+CSRankings.noteMap[this.note[h]]+'">')+this.note[h]+"</a>]</span>&nbsp;");this.acmfellow.hasOwnProperty(h)&&(l+='<span title="ACM Fellow"><img alt="ACM Fellow" src="'+this.acmfellowImage+'"></span>&nbsp;');this.turing.hasOwnProperty(h)&&(l+='<span title="Turing Award"><img alt="Turing Award" src="'+this.turingImage+'"></span>&nbsp;');l+='<span class="areaname">'+this.areaString(h).toLowerCase()+
"</span>&nbsp;";l+='<a title="Click for author\'s home page." target="_blank" href="'+k+'" onclick="trackOutboundLink(\''+k+'\', true); return false;"><img alt="Home page" src="'+this.homepageImage+'"></a>&nbsp;';this.scholarInfo.hasOwnProperty(h)&&"NOSCHOLARPAGE"!=this.scholarInfo[h]&&(k="https://scholar.google.com/citations?user="+this.scholarInfo[h]+"&hl=en&oi=ao",l+='<a title="Click for author\'s Google Scholar page." target="_blank" href="'+k+'" onclick="trackOutboundLink(\''+k+'\', true); return false;"><img alt="Google Scholar" src="scholar-favicon.ico" height="10" width="10"></a>&nbsp;');
l+='<a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+n+'\', true); return false;"><img alt="DBLP" src="dblp.png"></a>';l+="<span onclick='csr.toggleChart(\""+escape(h)+'");\' title="Click for author\'s publication profile." class="hovertip" id="'+escape(h)+"-chartwidget\"><span class='piechart'>"+this.PieChart+'</span></span></small></td><td align="right"><small><a title="Click for author\'s DBLP entry." target="_blank" href="'+n+'" onclick="trackOutboundLink(\''+
n+"', true); return false;\">"+f.fc[h]+'</a></small></td><td align="right"><small>'+(Math.round(10*d[h])/10).toFixed(1)+'</small></td></tr><tr><td colspan="4"><div style="display:none;" id="'+escape(h)+'-chart"></div></td></tr>'}l+="</tbody></table></div>";e[g]=l}f={fc:f.fc}}return e};
...
a){a=1;var f=0,g=9999999.999;for(l in this.stats)this.stats[l]=Math.round(10*this.stats[l])/10;var l=this.sortIndex(this.stats);for(var m=0;m<l.length;m++){var h=l[m],k=this.stats[h];if(m>=c&&k!=g)break;if(0===k)break;g!=k&&(this.useDenseRankings?f+=1:(f+=a,a=0));g=escape(h);e+="\n<tr><td>"+f+"&nbsp;</td>";e+='<td><span class="hovertip" onclick="csr.toggleFaculty(\''+g+'\');" id="'+g+'-widget"><font color="blue">'+this.RightTriangle+"</font></span>";e+="&nbsp;"+h+'&nbsp;<span class="hovertip" onclick="csr.toggleChart(\''+
g+'\');" id="'+g+'-chartwidget">'+this.PieChart+"</span>";e+="</td>";e+='<td align="right">'+(Math.round(10*k)/10).toFixed(1)+"</td>";e+='<td align="right">'+b[h];e+="</td>";e+="</tr>\n";e+='<tr><td colspan="4"><div style="display:none;" style="width: 100%; height: 350px;" id="'+g+'-chart"></div></td></tr>';e+='<tr><td colspan="4"><div style="display:none;" id="'+g+'-faculty">'+d[h]+"</div></td></tr>";a++;g=k}e+="</tbody></table><br /></div></div>\n<br></body></html>"}else e="<h3>Please select at least one area by clicking one or more checkboxes.</h3>";
...
CSRankings.prototype.rank=function(a){a=void 0===a?!0:a;var b=performance.now(),d={},c={},e={},f={},g={};this.areaDeptAdjustedCount={};var l=parseInt($("#fromyear").find(":selected").text()),m=parseInt($("#toyear").find(":selected").text()),h=String($("#regions").find(":selected").val()),k=this.updateWeights(g);this.buildDepartments(l,m,g,h,c,d,e,f);this.computeStats(d,k,g);d=this.buildDropDown(d,e,f);c=this.buildOutputString(k,c,d,CSRankings.minToRank);$("#success").html(c);$("div").scroll(function(){if(this.scrollTop+
this.clientHeight>this.scrollHeight-50){var a=CSRankings.updateMinimum(this);a&&$("div").scrollTop(a)}});a?this.navigoRouter.resume():this.navigoRouter.pause();a=this.updatedURL();this.navigoRouter.navigate(a);a=performance.now();console.log("Rank took "+(a-b)+" milliseconds.");return!1};
...
0:1):a.allChecked&c}}(c)),c.allChecked&&(a+=this.fields[e]+"&",b+=1))}0<b&&(a=a.slice(0,-1));c=$("#regions").find(":selected").val();e="";f=(new Date).getFullYear();var g=parseInt($("#fromyear").find(":selected").text()),l=parseInt($("#toyear").find(":selected").text());if(g!=f-10||l!=f)e+="/fromyear/"+g.toString(),e+="/toyear/"+l.toString();e=b==d?e+"/index?all":0==b?e+"/index?none":e+("/index?"+a);"USA"!=c&&(e+="&"+c);return e};
...
str:b.str},d++)b.str="input[name="+this.fields[d]+"]",b.field=this.fields[d],$(b.str).click(function(b){return function(){var c=!0;if(b.field in CSRankings.parentMap){c=!1;var d=CSRankings.parentMap[b.field],e="input[name="+d+"]",f=0,k=1;CSRankings.childMap[d].forEach(function(a){var b=$("input[name="+a+"]").prop("checked");f|=b;k=a in CSRankings.nextTier?k&(b?0:1):k&b});$(e).prop("checked",f);f&&!k||$(e).prop("disabled",!1);f&&!k&&$(e).prop("disabled",!0)}else if(d=$(b.str).prop("checked"),b.field in
...
CSRankings.nextTier={ase:!0,issta:!0,icde:!0,pods:!0,hpca:!0,ndss:!0,pets:!0,eurosys:!0,fast:!0,usenixatc:!0,icfp:!0,oopsla:!0};CSRankings.childMap={};CSRankings.noteMap={Tech:"https://tech.cornell.edu/",CBG:"https://www.mpi-cbg.de/",INF:"https://www.mpi-inf.mpg.de/",IS:"https://www.is.mpg.de/",MG:"https://www.molgen.mpg.de/2168/en",SP:"https://www.mpi-sp.org/",SWS:"https://www.mpi-sws.org/"};var csr=new CSRankings;
