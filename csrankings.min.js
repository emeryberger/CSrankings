...
default:jQuery("#regions").val("world")}})};a.addListeners=function(){for(var b=this,c=function(b){var c=a.areas[b];document.getElementById(c+"-widget").addEventListener("click",function(){a.toggleConferences(c)})},d=0;d<a.areas.length;d++)c(d);for(c=0;c<a.fields.length;c++)jQuery("input[name="+a.fields[c]+"]").click(function(){b.rank()});c=document.getElementById("all_areas_on");c.addEventListener("click",function(){a.activateAll()});c=document.getElementById("all_areas_off");c.addEventListener("click",
function(){a.activateNone()});c=document.getElementById("ai_areas_on");c.addEventListener("click",function(){a.activateAI()});c=document.getElementById("ai_areas_off");c.addEventListener("click",function(){a.deactivateAI()});c=document.getElementById("systems_areas_on");c.addEventListener("click",function(){a.activateSystems()});c=document.getElementById("systems_areas_off");c.addEventListener("click",function(){a.deactivateSystems()});c=document.getElementById("theory_areas_on");c.addEventListener("click",
function(){a.activateTheory()});c=document.getElementById("theory_areas_off");c.addEventListener("click",function(){a.deactivateTheory()});c=document.getElementById("other_areas_on");c.addEventListener("click",function(){a.activateOthers()});c=document.getElementById("other_areas_off");c.addEventListener("click",function(){a.deactivateOthers()})};return a}();CSRankings.authorFile="/csrankings.csv";CSRankings.authorinfoFile="/generated-author-info.csv";CSRankings.countryinfoFile="/country-info.csv";
CSRankings.aliasFile="/dblp-aliases.csv";CSRankings.homepagesFile="/homepages.csv";CSRankings.scholarFile="/scholar.csv";CSRankings.allowRankingChange=!1;CSRankings.parentMap={aaai:"ai",ijcai:"ai",cvpr:"vision",eccv:"vision",iccv:"vision"};CSRankings.childMap={ai:["aaai","ijcai"],vision:["cvpr","eccv","iccv"]};
