...
a.deactivateTheory=function(){return a.activateTheory(!1)};a.deactivateOthers=function(){return a.activateOthers(!1)};a.urlUpdate=function(){for(var b="",c=0,d=0;d<a.fields.length;d++)jQuery("input[name="+a.fields[d]+"]").prop("checked")&&(b+=a.fields[d]+"&",c+=1);0<c&&(b=b.slice(0,-1));b=c==a.fields.length?"":0==c?"/index?none":"/index?"+b;a.navigoRouter.navigate(b)};a.geoCheck=function(){jQuery.getJSON("http://freegeoip.net/json/",function(a){switch(a.country_code){case "US":jQuery("#regions").val("USA");
break;default:jQuery("#regions").val("world")}})};return a}();CSRankings.coauthorFile="/faculty-coauthors.csv";CSRankings.authorinfoFile="/generated-author-info.csv";CSRankings.countryinfoFile="/country-info.csv";CSRankings.aliasFile="/dblp-aliases.csv";CSRankings.homepagesFile="/homepages.csv";CSRankings.allowRankingChange=!1;CSRankings.showCoauthors=!1;CSRankings.maxCoauthors=30;CSRankings.parentMap={aaai:"ai",ijcai:"ai",cvpr:"vision",eccv:"vision",iccv:"vision"};
