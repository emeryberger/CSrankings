...
(this.authorAreas[e][l]=0)}if(!(h in this.authorAreas)){this.authorAreas[h]={};for(var m in this.areaDict)this.areaDict.hasOwnProperty(m)&&(this.authorAreas[h][m]=0)}this.authorAreas[e][c]+=f;this.authorAreas[h][c]+=f}}}else console.log("no property "+JSON.stringify(d))};
