...
var CSRankings=function(){var a=this;this.authorFile="/csrankings.csv";this.authorinfoFile="/generated-author-info.csv";this.countryinfoFile="/country-info.csv";this.aliasFile="/dblp-aliases.csv";this.turingFile="./turing.csv";this.acmfellowFile="./acm-fellows.csv";this.homepageImage="/house-logo.png";this.allowRankingChange=!1;this.areaMap=[{area:"ai",title:"AI"},{area:"aaai",title:"AI"},{area:"ijcai",title:"AI"},{area:"vision",title:"Vision"},{area:"cvpr",title:"Vision"},{area:"eccv",title:"Vision"},
{area:"iccv",title:"Vision"},{area:"mlmining",title:"ML"},{area:"icml",title:"ML"},{area:"kdd",title:"ML"},{area:"nips",title:"ML"},{area:"nlp",title:"NLP"},{area:"acl",title:"NLP"},{area:"emnlp",title:"NLP"},{area:"naacl",title:"NLP"},{area:"ir",title:"Web+IR"},{area:"sigir",title:"Web+IR"},{area:"www",title:"Web+IR"},{area:"arch",title:"Arch"},{area:"asplos",title:"Arch"},{area:"isca",title:"Arch"},{area:"micro",title:"Arch"},{area:"hpca",title:"Arch"},{area:"comm",title:"Networks"},{area:"sigcomm",
title:"Networks"},{area:"nsdi",title:"Networks"},{area:"sec",title:"Security"},{area:"ccs",title:"Security"},{area:"oakland",title:"Security"},{area:"usenixsec",title:"Security"},{area:"ndss",title:"Security"},{area:"pets",title:"Security"},{area:"mod",title:"DB"},{area:"sigmod",title:"DB"},{area:"vldb",title:"DB"},{area:"icde",title:"DB"},{area:"pods",title:"DB"},{area:"hpc",title:"HPC"},{area:"sc",title:"HPC"},{area:"hpdc",title:"HPC"},{area:"ics",title:"HPC"},{area:"mobile",title:"Mobile"},{area:"mobicom",
title:"Mobile"},{area:"mobisys",title:"Mobile"},{area:"sensys",title:"Mobile"},{area:"metrics",title:"Metrics"},{area:"imc",title:"Metrics"},{area:"sigmetrics",title:"Metrics"},{area:"ops",title:"OS"},{area:"sosp",title:"OS"},{area:"osdi",title:"OS"},{area:"fast",title:"OS"},{area:"usenixatc",title:"OS"},{area:"eurosys",title:"OS"},{area:"pldi",title:"PL"},{area:"popl",title:"PL"},{area:"icfp",title:"PL"},{area:"oopsla",title:"PL"},{area:"plan",title:"PL"},{area:"soft",title:"SE"},{area:"fse",title:"SE"},
{area:"icse",title:"SE"},{area:"ase",title:"SE"},{area:"issta",title:"SE"},{area:"act",title:"Theory"},{area:"focs",title:"Theory"},{area:"soda",title:"Theory"},{area:"stoc",title:"Theory"},{area:"crypt",title:"Crypto"},{area:"crypto",title:"Crypto"},{area:"eurocrypt",title:"Crypto"},{area:"log",title:"Logic"},{area:"cav",title:"Logic"},{area:"lics",title:"Logic"},{area:"graph",title:"Graphics"},{area:"siggraph",title:"Graphics"},{area:"siggraph-asia",title:"Graphics"},{area:"chi",title:"HCI"},{area:"chiconf",
...
title:"Visualization"},{area:"vis",title:"Visualization"},{area:"vr",title:"Visualization"},{area:"ecom",title:"ECom"},{area:"ec",title:"ECom"},{area:"wine",title:"ECom"}];this.aiAreas=["ai","vision","mlmining","nlp","ir"];this.systemsAreas="arch comm sec mod hpc mobile metrics ops plan soft da bed".split(" ");this.theoryAreas=["act","crypt","log"];this.interdisciplinaryAreas="graph chi robotics bio visualization ecom".split(" ");this.areaNames=[];this.fields=[];this.aiFields=[];this.systemsFields=
[];this.theoryFields=[];this.otherFields=[];this.areaDict={};this.areaPosition={};this.scholarInfo={};this.aliases={};this.turing={};this.acmfellow={};this.countryInfo={};this.homepages={};this.useDenseRankings=!1;this.authors=[];this.authorAreas={};this.stats={};this.areaDeptAdjustedCount={};this.color="#f30000 #0600f3 #00b109 #14e4b4 #0fe7fb #67f200 #ff7e00 #8fe4fa #ff5300 #640000 #3854d1 #d00ed8 #7890ff #01664d #04231b #e9f117 #f3228e #7ce8ca #ff5300 #ff5300 #7eff30 #9a8cf6 #79aff9 #bfbfbf #56b510 #00e2f6 #ff4141 #61ff41".split(" ");
...
CSRankings.prototype.countAuthorAreas=function(a,b){for(var d in this.authors)if(this.authors.hasOwnProperty(d)){var c=this.authors[d],f=c.year;if(!(f<a||f>b||(f=c.area,f in CSRankings.nextTier))){var e=c.dept,h=parseFloat(c.count);c=c.name;c in this.aliases&&(c=this.aliases[c]);if(!(c in this.authorAreas)){this.authorAreas[c]={};for(var k in this.areaDict)this.areaDict.hasOwnProperty(k)&&(this.authorAreas[c][k]=0)}if(!(e in this.authorAreas)){this.authorAreas[e]={};for(var l in this.areaDict)this.areaDict.hasOwnProperty(l)&&
(this.authorAreas[e][l]=0)}this.authorAreas[c][f]+=h;this.authorAreas[e][f]+=h}}};
CSRankings.prototype.buildDepartments=function(a,b,d,c,f,e,h,k){var l={},g;for(g in this.authors)if(this.authors.hasOwnProperty(g)){var m=this.authors[g],n=m.name,q=m.year,p=m.area;m=m.dept;n in this.aliases&&(n=this.aliases[n]);if("undefined"!==typeof m&&!(0===d[p]||q<a||q>b)&&this.inRegion(m,c)){p in CSRankings.parentMap&&(p=CSRankings.parentMap[p]);q=p+m;p=n+m;q in this.areaDeptAdjustedCount||(this.areaDeptAdjustedCount[q]=0);var t=parseInt(this.authors[g].count),r=parseFloat(this.authors[g].adjustedcount);
this.areaDeptAdjustedCount[q]+=r;n in l||(l[n]=!0,h[p]=0,k[p]=0,m in f||(f[m]=0,e[m]=[]),e[m].push(n),f[m]+=1);h[p]+=t;k[p]+=r}}};
...
{};for(var l=$jscomp.makeIterator(a[e.dept]),g=l.next();!g.done;g=l.next())g=g.value,e.fc[g]=b[g+e.dept];l=Object.keys(e.fc);l.sort(function(a){return function(b,e){if(a.fc[e]===a.fc[b]){var f=Math.round(10*d[e+a.dept])/10,h=Math.round(10*d[b+a.dept])/10;return f===h?c.compareNames(b,e):f-h}return a.fc[e]-a.fc[b]}}(e));l=$jscomp.makeIterator(l);for(g=l.next();!g.done;g=l.next()){g=g.value;var m=encodeURI(this.homepages[g]),n=this.translateNameToDBLP(g);k+='<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><small><a title="Click for author\'s home page." target="_blank" href="'+
m+'" onclick="trackOutboundLink(\''+m+"', true); return false;\">"+g+"</a>&nbsp;";this.acmfellow.hasOwnProperty(g)&&this.turing.hasOwnProperty(g)?k+="<b>[Turing Award, ACM Fellow]</b>&nbsp;":(this.acmfellow.hasOwnProperty(g)&&(k+="<b>[ACM Fellow]</b>&nbsp;"),this.turing.hasOwnProperty(g)&&(k+="<b>[Turing Award]</b>&nbsp;"));k+='<font style="font-variant:small-caps" size="-1">'+this.areaString(g).toLowerCase()+"</em></font>&nbsp;";k+='<a title="Click for author\'s home page." target="_blank" href="'+
m+'" onclick="trackOutboundLink(\''+m+'\', true); return false;"><img src="'+this.homepageImage+'"></a>&nbsp;';this.scholarInfo.hasOwnProperty(g)&&"NOSCHOLARPAGE"!=this.scholarInfo[g]&&(m="https://scholar.google.com/citations?user="+this.scholarInfo[g]+"&hl=en&oi=ao",k+='<a title="Click for author\'s Google Scholar page." target="_blank" href="'+m+'" onclick="trackOutboundLink(\''+m+'\', true); return false;"><img src="scholar-favicon.ico" height="10" width="10"></a>&nbsp;');k+='<a title="Click for author\'s DBLP entry." target="_blank" href="'+
