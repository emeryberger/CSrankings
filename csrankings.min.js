...
m in b&&(console.log("dept = "+m+", abbrv = "+b[m]),p=b[m]);h+="&nbsp;"+m+('&nbsp;<img src="/flags/'+p+'.png">&nbsp;<span class="hovertip" onclick="csr.toggleChart(\'')+g+'\');" id="'+g+'-chartwidget">'+this.PieChart+"</span>";h+="</td>";h+='<td align="right">'+(Math.round(10*n)/10).toFixed(1)+"</td>";h+='<td align="right">'+c[m];h+="</td>";h+="</tr>\n";h+='<tr><td colspan="4"><div class="csr-piechart" id="'+g+'-chart"></div></td></tr>';h+='<tr><td colspan="4"><div style="display:none;" id="'+g+'-faculty">'+
d[m]+"</div></td></tr>";a++;g=n}h+="</tbody></table><br /></div></div>\n<br></body></html>"}else h="<h3>Please select at least one area by clicking one or more checkboxes.</h3>";return h};CSRankings.prototype.setAllOn=function(a){a=void 0===a?!0:a;for(var b=0;b<CSRankings.areas.length;b++){var c=this.fields[b],d="input[name="+c+"]";a?c in CSRankings.nextTier?$(d).prop("checked",!1):($(d).prop("checked",!0),$(d).prop("disabled",!1)):($(d).prop("checked",!1),$(d).prop("disabled",!1))}};
