...
a.addListeners=function(){for(var b=this,c=function(b){var c=a.areas[b];document.getElementById(c+"-widget").addEventListener("click",function(){a.toggleConferences(c)})},d=0;d<a.areas.length;d++)c(d);for(c=0;c<a.fields.length;c++)jQuery("input[name="+a.fields[c]+"]").click(function(){b.rank()})};return a}();CSRankings.authorFile="/csrankings.csv";CSRankings.authorinfoFile="/generated-author-info.csv";CSRankings.countryinfoFile="/country-info.csv";CSRankings.aliasFile="/dblp-aliases.csv";
