...
a.deactivateTheory=function(){return a.activateTheory(!1)};a.deactivateOthers=function(){return a.activateOthers(!1)};a.urlUpdate=function(){for(var b="",c=0,d=0;d<a.fields.length;d++)jQuery("input[name="+a.fields[d]+"]").prop("checked")&&(b+=a.fields[d]+"&",c+=1);0<c&&(b=b.slice(0,-1));b=c==a.fields.length?"":0==c?"/index?none":"/index?"+b;a.navigoRouter.navigate(b)};return a}();CSRankings.coauthorFile="/faculty-coauthors.csv";CSRankings.authorinfoFile="/generated-author-info.csv";
