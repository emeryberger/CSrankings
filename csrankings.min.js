...
CSRankings.geoCheck=function(){jQuery.getJSON("https://freegeoip.app/json/",function(a){switch(a.country_code){case "US":case "CN":case "IN":case "KR":case "JP":case "TW":case "SG":jQuery("#regions").val("USA");CSRankings.getInstance().rank();break;default:jQuery("#regions").val("world"),CSRankings.getInstance().rank()}}).fail(function(){CSRankings.getInstance().rank()})};
