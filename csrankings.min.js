...
c.length;b++)d=c[b],a.otherFields.push(a.areaPosition[d]);(function(){a.loadAliases(a.aliases,function(){a.loadAuthorInfo(function(){a.loadAuthors(function(){a.loadCountryInfo(a.countryInfo,a.rank)})})})})();a.activateAll();a.navigoRouter=new Navigo(null,!0);a.navigoRouter.on("/index",a.navigator).resolve();a.navigoRouter.on("/fromyear/:fromyear/toyear/:toyear/index",a.navigator).resolve()}a.translateNameToDBLP=function(a){a=a.replace(/'|\-|\./g,"=");a=a.replace(/\u00c1/g,"=Aacute=");a=a.replace(/\u00e1/g,
