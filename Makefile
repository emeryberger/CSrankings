...
csrankings.js: csrankings.ts
	...
	tsc --noImplicitAny --noImplicitReturns --forceConsistentCasingInFileNames --noImplicitThis --noUnusedLocals --noUnusedParameters --noFallthroughCasesInSwitch --pretty csrankings.ts
