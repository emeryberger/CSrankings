...
def get_lat_long(university, countryabbrv):
    ...
    params = {"q": urllib.parse.quote_plus(university), "countrycode": countryabbrv, "key": api_key}
...
with open("country-info.csv", "r") as input_file, open("geolocation.csv", "w", newline="") as output_file:
    ...
    for row in reader:
        ...
        if lat_long is not None:
            ...
            writer.writerow({"institution": institution, "latitude": lat_long[0], "longitude": lat_long[1]})
