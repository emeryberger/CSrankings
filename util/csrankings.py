...
# 'ecom' : ['EC', 'WINE']
areadict: Dict[Area, List[Conference]] = {Area('popl'): [Conference('POPL')], Area('pldi'): [Conference('PLDI')], Area('oopsla'): [Conference('OOPSLA'), Conference('OOPSLA/ECOOP'), Conference('OOPSLA1'), Conference('OOPSLA2')], Area('icfp'): [Conference('ICFP')], Area('pacmpl'): [Conference('PACMPL'), Conference('Proc. ACM Program. Lang.')], Area('icse'): [Conference('ICSE'), Conference('ICSE (1)')], Area('fse'): [Conference('SIGSOFT FSE'), Conference('ESEC/SIGSOFT FSE')], Area('ase'): [Conference('ASE')], Area('issta'): [Conference('ISSTA')], Area('sosp'): [Conference('SOSP')], Area('osdi'): [Conference('OSDI')], Area('eurosys'): [Conference('EuroSys')], Area('fast'): [Conference('FAST')], Area('usenixatc'): [Conference('USENIX Annual Technical Conference'), Conference('USENIX Annual Technical Conference, General Track')], Area('imc'): [Conference('IMC'), Conference('Internet Measurement Conference')], Area('sigmetrics'): [Conference('SIGMETRICS'), Conference('SIGMETRICS/Performance'), Conference('POMACS'), Conference('Proc. ACM Meas. Anal. Comput. Syst.')], Area('mobisys'): [Conference('MobiSys')], Area('mobicom'): [Conference('MobiCom'), Conference('MOBICOM')], Area('sensys'): [Conference('SenSys')], Area('sc'): [Conference('SC')], Area('hpdc'): [Conference('HPDC')], Area('ics'): [Conference('ICS')], Area('emsoft'): [Conference('EMSOFT'), Conference('ACM Trans. Embedded Comput. Syst.'), Conference('ACM Trans. Embed. Comput. Syst.'), Conference('IEEE Trans. Comput. Aided Des. Integr. Circuits Syst.')], Area('rtss'): [Conference('RTSS'), Conference('rtss')], Area('rtas'): [Conference('RTAS'), Conference('IEEE Real-Time and Embedded Technology and Applications Symposium')], Area('iccad'): [Conference('ICCAD')], Area('dac'): [Conference('DAC')], Area('vldb'): [Conference('VLDB'), Conference('PVLDB'), Conference('Proc. VLDB Endow.')], Area('sigmod'): [Conference('SIGMOD Conference'), Conference('Proc. ACM Manag. Data')], Area('icde'): [Conference('ICDE')], Area('pods'): [Conference('PODS')], Area('ccs'): [Conference('CCS'), Conference('ACM Conference on Computer and Communications Security')], Area('oakland'): [Conference('IEEE Symposium on Security and Privacy'), Conference('SP')], Area('usenixsec'): [Conference('USENIX Security Symposium'), Conference('USENIX Security')], Area('ndss'): [Conference('NDSS')], Area('pets'): [Conference('PoPETs'), Conference('Privacy Enhancing Technologies'), Conference('Proc. Priv. Enhancing Technol.')], Area('sigcomm'): [Conference('SIGCOMM')], Area('nsdi'): [Conference('NSDI')], Area('asplos'): [Conference('ASPLOS'), Conference('ASPLOS (1)'), Conference('ASPLOS (2)'), Conference('ASPLOS (3)')], Area('isca'): [Conference('ISCA')], Area('micro'): [Conference('MICRO')], Area('hpca'): [Conference('HPCA')], Area('cav'): [Conference('CAV'), Conference('CAV (1)'), Conference('CAV (2)'), Conference('CAV (3)') ], Area('lics'): [Conference('LICS'), Conference('CSL-LICS')], Area('focs'): [Conference('FOCS')], Area('stoc'): [Conference('STOC')], Area('soda'): [Conference('SODA')], Area('nips'): [Conference('NIPS'), Conference('NeurIPS')], Area('icml'): [Conference('ICML'), Conference('ICML (1)'), Conference('ICML (2)'), Conference('ICML (3)')], Area('iclr'): [Conference('ICLR')], Area('kdd'): [Conference('KDD')], Area('aaai'): [Conference('AAAI'), Conference('AAAI/IAAI')], Area('ijcai'): [Conference('IJCAI')], Area('siggraph'): [Conference('ACM Trans. Graph.'), Conference('SIGGRAPH')], Area('siggraph-asia'): [Conference('ACM Trans. Graph.'), Conference('SIGGRAPH Asia')], Area('eurographics'): [Conference('Comput. Graph. Forum'), Conference('EUROGRAPHICS')], Area('sigir'): [Conference('SIGIR')], Area('www'): [Conference('WWW')], Area('chiconf'): [Conference('CHI')], Area('ubicomp'): [Conference('UbiComp'), Conference('Ubicomp'), Conference('IMWUT'), Conference('Pervasive'), Conference('Proc. ACM Interact. Mob. Wearable Ubiquitous Technol.')], Area('uist'): [Conference('UIST')], Area('emnlp'): [Conference('EMNLP'), Conference('EMNLP (1)'), Conference('EMNLP-CoNLL'), Conference('HLT/EMNLP'), Conference('EMNLP-IJCNLP'), Conference('EMNLP/IJCNLP (1)')], Area('acl'): [Conference('ACL'), Conference('ACL (1)'), Conference('ACL (2)'), Conference('ACL/IJCNLP'), Conference('ACL/IJCNLP (1)'), Conference('ACL/IJCNLP (2)'), Conference('COLING-ACL')], Area('naacl'): [Conference('NAACL'), Conference('HLT-NAACL'), Conference('NAACL-HLT'), Conference('NAACL-HLT (1)')], Area('cvpr'): [Conference('CVPR'), Conference('CVPR (1)'), Conference('CVPR (2)')], Area('iccv'): [Conference('ICCV')], Area('eccv'): [Conference('ECCV'), Conference('ECCV (1)'), Conference('ECCV (2)'), Conference('ECCV (3)'), Conference('ECCV (4)'), Conference('ECCV (5)'), Conference('ECCV (6)'), Conference('ECCV (7)'), Conference('ECCV (8)'), Conference('ECCV (9)'), Conference('ECCV (10)'), Conference('ECCV (11)'), Conference('ECCV (12)'), Conference('ECCV (13)'), Conference('ECCV (14)'), Conference('ECCV (15)'), Conference('ECCV (16)'), Conference('ECCV (17)'), Conference('ECCV (18)'), Conference('ECCV (19)'), Conference('ECCV (20)'), Conference('ECCV (21)'), Conference('ECCV (22)'), Conference('ECCV (23)'), Conference('ECCV (24)'), Conference('ECCV (25)'), Conference('ECCV (26)'), Conference('ECCV (27)'), Conference('ECCV (28)'), Conference('ECCV (29)'), Conference('ECCV (30)'), Conference('ECCV (31)'), Conference('ECCV (32)'), Conference('ECCV (33)'), Conference('ECCV (34)'), Conference('ECCV (35)'), Conference('ECCV (36)'), Conference('ECCV (37)'), Conference('ECCV (38)'), Conference('ECCV (39)')], Area('icra'): [Conference('ICRA'), Conference('ICRA (1)'), Conference('ICRA (2)')], Area('iros'): [Conference('IROS')], Area('rss'): [Conference('Robotics: Science and Systems')], Area('crypto'): [Conference('CRYPTO'), Conference('CRYPTO (1)'), Conference('CRYPTO (2)'), Conference('CRYPTO (3)'), Conference('CRYPTO (4)'), Conference('CRYPTO (5)')], Area('eurocrypt'): [Conference('EUROCRYPT'), Conference('EUROCRYPT (1)'), Conference('EUROCRYPT (2)'), Conference('EUROCRYPT (3)'), Conference('EUROCRYPT (4)'), Conference('EUROCRYPT (5)')], Area('ismb'): [Conference('ISMB'), Conference('Bioinformatics'), Conference('Bioinform.'), Conference('ISMB/ECCB (Supplement of Bioinformatics)'), Conference('Bioinformatics [ISMB/ECCB]'), Conference('ISMB (Supplement of Bioinformatics)')], Area('recomb'): [Conference('RECOMB')], Area('vis'): [Conference('IEEE Visualization'), Conference('IEEE Trans. Vis. Comput. Graph.')], Area('vr'): [Conference('VR')], Area('ec'): [Conference('EC')], Area('wine'): [Conference('WINE')], Area('sigcse'): [Conference('SIGCSE')]}
...
# Assuming all will be in the same issues through 2023.
TOG_SIGGRAPH_Asia_Volume = {2023: (42, 6), 2022: (41, 6), 2021: (40, 6), 2020: (39, 6), 2019: (38, 6), 2018: (37, 6), 2017: (36, 6), 2016: (35, 6), 2015: (34, 6), 2014: (33, 6), 2013: (32, 6), 2012: (31, 6), 2011: (30, 6), 2010: (29, 6), 2009: (28, 5), 2008: (27, 5)}
# CGF special handling to count only EUROGRAPHICS proceedings.
# Assuming all will be in the same issues through 2023.
CGF_EUROGRAPHICS_Volume = {2023: (42, 2), 2022: (41, 2), 2021: (40, 2), 2020: (39, 2), 2019: (38, 2), 2018: (37, 2), 2017: (36, 2), 2016: (35, 2), 2015: (34, 2), 2014: (33, 2), 2013: (32, 2), 2012: (31, 2), 2011: (30, 2), 2010: (29, 2), 2009: (28, 2), 2008: (27, 2), 2007: (26, 3), 2006: (25, 3), 2005: (24, 3), 2004: (23, 3), 2003: (22, 3), 2002: (21, 3), 2001: (20, 3), 2000: (19, 3), 1999: (18, 3), 1998: (17, 3), 1997: (16, 3), 1996: (15, 3), 1995: (14, 3), 1994: (13, 3), 1993: (12, 3), 1992: (11, 3)}
# TVCG special handling to count only IEEE VIS
TVCG_Vis_Volume = {2023: (29, 1), 2022: (28, 1), 2021: (27, 2), 2020: (26, 1), 2019: (25, 1), 2018: (24, 1), 2017: (23, 1), 2016: (22, 1), 2014: (20, 12), 2013: (19, 12), 2012: (18, 12), 2011: (17, 12), 2010: (16, 6), 2009: (15, 6), 2008: (14, 6), 2007: (13, 6), 2006: (12, 5)}
# TVCG special handling to count only IEEE VR
TVCG_VR_Volume = {2022: (28, 5), 2021: (27, 5), 2020: (26, 5), 2019: (25, 5), 2018: (24, 4), 2017: (23, 4), 2016: (22, 4), 2015: (21, 4), 2014: (20, 4), 2013: (19, 4), 2012: (18, 4)}
...
ICSE_ShortPaperStart = {2013: 851, 2012: 957, 2011: 620, 2010: 544, 2009: 550, 2007: 510, 2006: 411, 2005: 478, 2003: 477, 2002: 534, 2001: 502, 2000: 518, 1999: 582, 1998: 419, 1997: 535}
...
SIGMOD_NonResearchPaperStart = {2017: 1587, 2016: 2069, 2013: 917, 2012: 577, 2011: 1045, 2010: 963, 2009: 841, 2008: 1043, 2007: 873, 2006: 695, 2005: 778, 2004: 839, 2003: 635, 2002: 500, 2001: 521, 2000: 499, 1999: 503, 1998: 496, 1997: 498, 1996: 541, 1995: 423, 1994: 466, 1993: 388}
...
# filtering.
SIGMOD_NonResearchPapersRange = {2018: [(177, 230), (583, 627), (789, 839), (1393, 1459), (1637, 1845)], 2017: [(1, 3), (51, 63), (125, 138), (331, 343), (1041, 1052), (511, 526), (1587, 1782)], 2016: [(1753, 1764), (1295, 1306), (795, 806), (227, 238), (999, 1010), (1923, 1934), (1307, 1318), (1951, 1960), (759, 771), (253, 265), (1405, 1416), (215, 226), (1105, 1117), (35, 46), (63, 75), (807, 819), (1099, 1104), (1087, 1098), (847, 859), (239, 251), (1393, 1404), (2069, 2243)], 2015: [(227, 276), (607, 658), (1343, 1394), (1657, 1706), (1917, 1940), (859, 918), (1063, 1122), (1403, 1462)], 2014: [(147, 188), (337, 384), (529, 573), (1223, 1258)]}
...
def countPaper(confname: Conference, year: int, volume: str, number: str, pages: str, startPage: int, pageCount: int, url: str, title: Title) -> bool:
    """Returns true iff this paper will be included in the rankings."""
    if year < startyear or year > endyear:
        return False
    # Special handling for EMSOFT (TECS).
    if confname in ['ACM Trans. Embedded Comput. Syst.', 'ACM Trans. Embed. Comput. Syst.']:
    ...
    if confname == 'IEEE Trans. Comput. Aided Des. Integr. Circuits Syst.':
        if year not in EMSOFT_TCAD:
            return False
        if int(volume) != EMSOFT_TCAD[year][0] or int(number) != EMSOFT_TCAD[year][1] or startPage not in EMSOFT_TCAD_PaperStart[year]:
            return False
